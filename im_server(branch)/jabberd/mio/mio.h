...
/** for creating a new_cplus listen socket in this mio (returns new_cplus fd or <0) */
#define mio_listen(m, port, sourceip, app, arg) \
    (*m)->mio_listen(m, port, sourceip, app, arg)

/** for creating a new_cplus socket connected to this ip:port (returns new_cplus fd or <0, use mio_read/write first) */
