...
static void _sx_server_element_start(void *arg, const char *name, const char **atts) {
    ...
    if((int)strlen(name) < i || strncmp(name, uri_STREAMS "|stream", i) != 0 || (name[i] != '\0' && name[i] != '|')) {
        /* throw an error */
    ...
    /* we're alive */
    XML_SetElementHandler(s->expat, (XML_StartElementHandler) _sx_element_start, (XML_EndElementHandler) _sx_element_end);
    XML_SetCharacterDataHandler(s->expat, (XML_CharacterDataHandler) _sx_cdata);
    XML_SetStartNamespaceDeclHandler(s->expat, (XML_StartNamespaceDeclHandler) _sx_namespace_start);
...
void sx_server_init(sx_t s, unsigned int flags) {
    ...
    /* we want to read */
    XML_SetElementHandler(s->expat, (XML_StartElementHandler) _sx_server_element_start, (XML_EndElementHandler) _sx_server_element_end);
    XML_SetStartNamespaceDeclHandler(s->expat, (XML_StartNamespaceDeclHandler) _sx_server_ns_start);
