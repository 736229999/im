...
public:
	...
	void HttpServicePushQuit(const char *params, Json::Value& jvReply);
	// 判断主管能否插入会话
	void HttpServiceIsEnableInsertMsg(const char *params, Json::Value& jvReply);
	// 判断主管能否强制下线客服
	void HttpServiceForceOffline(const char *params, Json::Value& jvReply);
	CDataBaseMini m_pDataBaseMini;
