...
{
	CDatabaseMini * MiniDB = (CDatabaseMini * )m_MiniDB;
	return MiniDB->WebRecommSave(fid,did,recomm,time);
}
...
{
	CDatabaseMini * MiniDB = (CDatabaseMini * )m_MiniDB;
	return MiniDB->WebHistoryMsg(nFromID,nToID,nStartMsgID,nStartTime,nEndTime,nMaxMsg,nRetCount,lsMsg);
}
...
{
	CDatabaseMini * MiniDB = (CDatabaseMini * )m_MiniDB;
	return MiniDB->XmppBusiListReq(BusiListReq,pListInfo,nRetCount);
}
...
{
	CDatabaseMini * MiniDB = (CDatabaseMini * )m_MiniDB;
	return MiniDB->Save_Offline_Msg(iRecvID,iSendID,iNatIP,iNatPort,iTime,iMsgType,strMsg,iMsgLen,strText,sendtime,uuid);
}
...
CDataBaseFamily::~CDataBaseFamily()
{
	delete (CDataBaseFamily*)m_FamilyDB;
}
