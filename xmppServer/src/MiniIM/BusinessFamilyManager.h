...
public:
	...
	void TransitSetMemberMsg(uint32 recvID, uint8 action, uint32 actionID, uint32 familyID, uint8 familyProp, const char* familyName,uint32 familyMsgID = 0, uint32 nInviteID = 0);
};
