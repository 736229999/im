...
#define uri_FLOW "jabber:iq:flow"
#define uri_LATESTMERCHANT "jabber:iq:latestmerchant"
#define uri_USERINFO "jabber:iq:userinfo"
#define uri_MSG "jabber:iq:msg"
#define uri_HEARTBEAT "jabber:iq:ping"
#define uri_HISTORYMSG "jabber:iq:historymsg"
