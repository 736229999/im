...
#define DB_GROUP_FULL					10	//用户分组已达到限制
#define DB_FRIENDS_FULL					11	//用户所加的好友已满
#define DB_NOFRIEND						12  //该用户不是您的好友
#define DB_USERNAME_EXIST				13	//该用户名已经存在
#define DB_NICKNAME_EXIST				14  //该昵称已经存在
#define DB_NICKNAME_ERROR				15	//昵称包含非法字符

#define DB_FAMILYNAME_ERROR				16	//家族名称包含非法字符
#define DB_NOACTIVE						17  //注册用户未激活
