...
(function($) {
	...
	if (/^https?\:\/\/[-\w]+\.feiniu\.com/.test(location.href)) { // Online环境
		...
		feiniu.config.merchantHost = 'http://merchant-api.feiniu.com';
		...
		feiniu.config.smartUrlStaticHost = 'http://10.211.64.68:8080/imgweb/image/'; //缩略图URL前缀
		feiniu.config.storeHost = 'http://wh-test01.fn.com';
		...
		feiniu.config.itemHost = 'http://item.beta.fn.com/FeiniuItemCommonWeb/goodsinfo_api/get_moumouattribute_by_skuid/';
		feiniu.config.smartUrlStaticHost = 'http://10.211.64.68:8080/imgweb/image/'; //缩略图URL前缀
		feiniu.config.storeHost = 'http://storeservice.beta.fn.com/merchantStore/';
		feiniu.config.detailGoodsHost = 'http://wh-item.fn.com/item/';
	}
	...
	feiniu.fn.callService = function (options) {
		...
		feiniu.fn.ajax(options.host + '/api/call.do?callback=?', {
			type: "post",
			data: {
