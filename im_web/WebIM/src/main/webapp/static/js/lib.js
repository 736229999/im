...
function getparam() {
    ...
    for (var c = location.search.substring(1), d = c.split("&"), e = 0; e < d.length; e++) {
        var f = d[e].indexOf("=");
        -1 != f && (d[e].substring(0, f), "sid" == d[e].substring(0, f) && (a = unescape(d[e].substring(f + 1))), "t" == d[e].substring(0, f) && (b = unescape(d[e].substring(f + 1))))
    }
...
!function () {
    ...
    a.suffix === !1 ? "" : "[]";
    var d = a.prefix === !1 ? !1 : !0, e = d ? a.hash === !0 ? "#" : "?" : "", f = a.numbers === !1 ? !1 : !0;
    jQuery.query = new function () {
        var a = function (a, b) {
            ...
            var e = c.shift();
            if ("object" != typeof b && (b = null), "" === e)if (b || (b = []), a(b, Array))b.push(0 == c.length ? d : g(null, c.slice(0), d)); else if (a(b, Object)) {
                for (var f = 0; null != b[f++];);
                b[--f] = 0 == c.length ? d : g(b[f], c.slice(0), d)
            } else b = [], b.push(0 == c.length ? d : g(null, c.slice(0), d)); else if (e && e.match(/^\s*[0-9]+\s*$/)) {
                var h = parseInt(e, 10);
        ...
        function str(a, b) {
            ...
            switch (i && "object" == typeof i && "function" == typeof i.toJSON && (i = i.toJSON(a)), "function" == typeof rep && (i = rep.call(b, a, i)), typeof i) {
                ...
                case"object":
                    ...
                    if (rep && "object" == typeof rep)for (f = rep.length, c = 0; f > c; c += 1)d = rep[c], "string" == typeof d && (e = str(d, i, rep), e && g.push(quote(d) + (gap ? ": " : ":") + e)); else for (d in i)Object.hasOwnProperty.call(i, d) && (e = str(d, i, rep), e && g.push(quote(d) + (gap ? ": " : ":") + e));
                    return e = 0 === g.length ? "{}" : gap ? "{\n" + gap + g.join(",\n" + gap) + "\n" + h + "}" : "{" + g.join(",") + "}", gap = h, e
            }
        }
...
!function () {
    ...
    var parse = function (a, b, c) {
        ...
        if (null != g.prefixFunc ? c.push(g.prefixFunc(f, b, d, e)) : c.push(g.prefix), null != g.suffix) {
            if (f.length <= 1)null != g.paramDefault && c.push(g.paramDefault); else for (var h = 1; h < f.length; h++)h > 1 && c.push(" "), c.push(f[h]);
            c.push(g.suffix)
        }
    ...
    a.fn.Jslider = function (b, c) {
        if (this.length) {
            ...
            var d = a.extend({
                ...
                } else 1 == d.slideDirection ? (f.css({width: d.slideWidth * d.data.length}), c = -d.slideWidth * b) : e = -d.slideHeight * b, f.animate({
                    top: e + "px",
                    left: c + "px"
                }, d.speed, function () {
                    d.defaultIndex = b
        ...
        function f() {
            ...
            var i = function (a) {
                ...
                if (a = 0 > a ? 0 : f > a ? a : f - 1, c = jQuery.extend({
                        text: a + 1,
                        classes: ""
                    }, c || {}), a == g)var d = $("<a href='javascript:void(0)' class='current'>" + c.text + "</a>"); else var d = $("<a>" + c.text + "</a>").bind("click", i(a)).attr("href", b.link_to.replace(/__id__/, a));
    ...
    a.extend(a.browser, {
        ...
        }, isIE6: a.browser && a.browser.msie && 6 == a.browser.version, isMinW: function (b) {
...
var jdRecent = {
    ...
    init: function () {
        ...
        if (this.list && null != this.list && "" != this.list)"" == b || -1 != this.list.indexOf(b) ? this.list = this.list : (this.list.split(".").length >= 10 && (this.list = this.list.replace(/.\d+$/, "")), this.list = b + "." + this.list); else {
...
var GlobalReco = function (a) {
    if (this.param = $.extend({
            ...
            uuid: -1,
            pin: readCookie("pin") || ""
        }, a.param), this.$el = a.$el, this.template = a.template, this.reBuildJSON = a.reBuildJSON, this.skuHooks = a.skuHooks || "SKUS_recommend", this.ext = a.ext || {}, this.callback = a.callback || function () {
        }, this.debug = a.debug, !this.param.p)throw new Error("The param [p] is not Specificed");
    this.init()
};
GlobalReco.prototype = {
    init: function () {
        var a = readCookie("__jda");
        this.param.lid = this.param.lid.indexOf("-") > 0 ? this.param.lid.split("-")[0] : "1", this.param.uuid = a ? "-" == a.split(".")[1] ? -1 : a.split(".")[1] : -1, this.get(this.rid)
    }, get: function () {
        var a, b = this, c = pageConfig.queryParam, d = [];
        if (pageConfig.product)for (a = 0; a < pageConfig.product.cat.length; a++)this.param["c" + (a + 1)] = pageConfig.product.cat[a];
        if (c) {
            for (var e in c)c.hasOwnProperty(e) && ("c1" == e || "c2" == e || "c3" == e ? b.param[e] = c[e] : d.push(e + ":" + c[e]));
            b.param.hi = d.join(",")
        }
        this.debug && 0, $.ajax({
            ...
            success: function (a) {
                var c = !!(a.success && a && a.data && a.data.length);
                c ? b.set(a) : b.$el.html('<div class="ac">\u300c\u6682\u65e0\u6570\u636e\u300d</div>'), this.debug && 0, b.callback.apply(b, [c, a])
            }
        })
    }, set: function (a) {
        pageConfig[this.skuHooks] = [], a.skuHooks = this.skuHooks, a.ext = this.ext, this.reBuildJSON && this.reBuildJSON > 0 && (a.data = tools.reBuildJSON(a.data, this.reBuildJSON)), this.debug && alert(this.template.process(a));
        try {
            this.$el.show().html(this.template.process(a))
        } catch (b) {
            /isdebug/.test(location.href) && "undefined" != typeof console && 0
        }
        this.setTrackCode(a.impr)
    }, setTrackCode: function (a) {
        var b = this.$el.find("li"), c = this, d = "&m=UA-J2011-1&ref=" + encodeURIComponent(document.referrer);
        b.each(function () {
            var a = $(this).attr("data-clk");
            $(this).bind("click", function (b) {
                var e = $(b.target);
                (e.is("a") || e.is("img") || e.is("span")) && c.newImage(a + d, !0), e.is("input") && 1 == e.attr("checked") && c.newImage(a + d, !0)
            })
        }), this.newImage(a + d, !0)
...
var category = {
    ...
    FN_GetLink: function (a, b) {
        function c(a, b) {
            return pageConfig.RE_HL_link = pageConfig.RE_HL_link || /sale.jd.com/, pageConfig.RE_HL_text = pageConfig.RE_HL_text || /11.11/, pageConfig.HL_style = "color:#E4393C", pageConfig.RE_HL_link.test(a) && pageConfig.RE_HL_text.test(b) ? pageConfig.HL_style : ""
        }
        ...
        switch (a) {
            case 1:
                ...
                break;
            case 2:
                d = b.split("|")[0], e = b.split("|")[1]
        }
        return "" == d ? e : (/^http[s]?:\/\/([\w-]+\.)+[\w-]+([\w-.\/?%&=]*)?$/.test(d) || (d = d.replace(/-000$/, ""), d = d.match(/^\d*-\d*$/) ? "http://channel.jd.com/" + d + ".html" : "http://list.jd.com/" + d + ".html"), '<a style="' + c(d, e) + '" href="' + d + '">' + e + "</a>")
    },
    ...
    DATA_Simple: {
        ...
        10: [{l: "http://channel.jd.com/car.html", n: "\u6574\u8f66"}, {
    ...
    FN_RefactorJSON: function (a, b) {
        for (var c = a.length / b, d = [], e = 0; c > e; e++)d.push({tabs: [], increment: null, count: b, skuids: []});
    ...
    getDataService: function (a) {
        ...
        }), this.OBJ.attr("load", "1").html(b.join("")), $.bigiframe(this.OBJ), this.FN_GetBrands();
        ...
        $("#_JD_ALLSORT").dropdown({
            ...
            "function" == typeof firstCategoryHover && firstCategoryHover(a)
        })
    },
    ...
    FN_Init: function () {
        if (this.OBJ.length) {
            this.OBJ.attr("load") || (window.pageConfig && 0 != window.pageConfig.pageId && this.FN_InitSimple(), $("#categorys").length ? $("#categorys").Jdropdown({delay: 200}) : $("#categorys-2013").Jdropdown({delay: 200}, function (a) {
                "function" == typeof allCategoryHover && allCategoryHover(a)
            }));
            var a = this;
    ...
    a.find("dl").Jdropdown({delay: 100}, function (a) {
        function b(a) {
            $.ajax({
                ...
                success: function (b) {
                    b && b[0] && a(b[0].productId)
                }
            })
        }

        a.attr("load") || $.login({
            automatic: !1, complete: function (c) {
                if (c) {
                    var d = a.find("dd").eq(0), e = "";
                    c.IsAuthenticated ? (e += UC.TPL_Regist.process(c), e += UC.TPL_OList.placeholder, e += UC.TPL_UList) : (e += UC.TPL_UnRegist, e += UC.TPL_UList), e += UC.TPL_VList.placeholder, d.html(e), readCookie("pin") ? b(function (a) {
                        "3" == a ? d.find(".J_jincai").show() : d.find(".J_baitiao").show()
                    }) : d.find(".J_baitiao").show(), a.attr("load", "1"), setTimeout(function () {
                        a.removeAttr("load")
                    }, 6e4), UC.FN_InitOList(), UC.FN_InitRecent()
                }
            }
        })
...
var $o = function () {
    ...
    a.prototype.init = function () {
        ...
        a.timeoutId && clearTimeout(a.timeoutId), a.timeoutId = setTimeout(function () {
            var c = $.trim(l.val());
            if (c === a.lastKeyword || !(c || readCookie("pin") || readCookie("_tp")))return !1;
            a.lastKeyword = c;
            var d = b.replace(i, {keyword: encodeURIComponent(c)});
            $.ajax({
                url: d, dataType: "jsonp", scriptCharset: "utf-8", jsonp: "callback", success: function (b) {
                    return function (c) {
        ...
        $.ajax({
            url: "http://search.jd.com/suggest.php?op=del&callback=?&key=" + encodeURIComponent(d),
            dataType: "jsonp",
            scriptCharset: "utf-8",
            beforeSend: function () {
