/*
 ...
 Author:keelii
 Date: 2014-12-09 1:20:40 [PM]
 */
function insertScript(t, e) {
    var i = document.getElementsByTagName("head")[0],
        s = document.createElement("script");
    if (s.setAttribute("type", "text/javascript"), e) for (var a in e) e.hasOwnProperty(a) && s.setAttribute(a, e[a]);
    s.setAttribute("src", t), i.appendChild(s)
}
function onNumChange() {
    var t = Number($("#buy-num").val()),
        e = $("#gift-tips a"),
        i = e.attr("href");
...
function strtotime(t, e) {
    ...
    function s(t) {
        var e = t.split(" "),
            ...
            o = "ago" === e[2],
            c = ("last" === s ? -1 : 1) * (o ? -1 : 1);
        if (n && (c *= parseInt(s, 10)), d.hasOwnProperty(a) && !e[1].match(/^mon(day|\.)?$/i)) return r["set" + d[a]](r["get" + d[a]]() + c);
        if ("wee" === a) return r.setDate(r.getDate() + 7 * c);
        if ("next" === s || "last" === s) i(s, a, c);
        else if (!n) return !1;
        return !0
    }

    var a, n, o, r, c, d, l, p, u, m;
    if (!t) return null;
    if (t = t.replace(/\s{2,}/g, " ").replace(/[\t\r\n]/g, "").toLowerCase(), "now" === t) return null === e || isNaN(e) ? 0 | (new Date).getTime() / 1e3 : 0 | e;
    if (!isNaN(a = Date.parse(t))) return 0 | a / 1e3;
    if ("now" === t) return (new Date).getTime() / 1e3;
    if (!isNaN(a = Date.parse(t))) return a / 1e3;
    if (n = t.match(/^(\d{2,4})-(\d{2})-(\d{2})(?:\s(\d{1,2}):(\d{2})(?::\d{2})?)?(?:\.(\d+)?)?$/)) return o = n[1] >= 0 && 69 >= n[1] ? +n[1] + 2e3 : n[1], new Date(o, parseInt(n[2], 10) - 1, n[3], n[4] || 0, n[5] || 0, n[6] || 0, n[7] || 0) / 1e3;
    if (r = e ? new Date(1e3 * e) : new Date, c = {
            ...
            min: "Minutes",
            sec: "Seconds"
        }, p = "(years?|months?|weeks?|days?|hours?|minutes?|min|seconds?|sec|sunday|sun\\.?|monday|mon\\.?|tuesday|tue\\.?|wednesday|wed\\.?|thursday|thu\\.?|friday|fri\\.?|saturday|sat\\.?)", u = "([+-]?\\d+\\s" + p + "|" + "(last|next)\\s" + p + ")(\\sago)?", n = t.match(RegExp(u, "gi")), !n) return !1;
    for (m = 0, l = n.length; l > m; m++) if (!s(n[m])) return !1;
...
function mktime() {
    var t = new Date,
        e = arguments,
        i = 0,
        s = ["Hours", "Minutes", "Seconds", "Month", "Date", "FullYear"];
    for (i = 0; s.length > i; i++) if (e[i] === void 0) e[i] = t["get" + s[i]](), e[i] += 3 === i;
    else if (e[i] = parseInt(e[i], 10), isNaN(e[i])) return !1;
...
function monthDay(t, e) {
    var i, s, a, n = new Date(1e3 * t),
        ...
        m = "",
        h = 12 * (l - r) + p - c;
    return i = Math.floor(h / 12), s = h % 12, s = 0 === s - Math.floor(s) ? s + 1 : s, a = (mktime(0, 0, 0, p, u, l) - mktime(0, 0, 0, p, d, l)) / 86400, 0 > a && (s -= 1), 0 > s && (i -= 1), i > 0 && (m += i + "年"), s > 0 && (m += s + "个月"), m
}
function el_top_middle(t, e, i) {
    ...
    var o = n.docHeight() != n.clientHeight() ? 16 : 0,
        r = $(document).scrollTop(),
        c = (n.clientHeight() - a) / 2 + r,
        d = (n.clientWidth() - o - s) / 2;
    t.css({
        left: d,
        top: c
    })
...
function showBaitiaoFq() {
    ...
    var e = 502,
        i = 358,
        s = '        <div id="Fqfk_Tip" class="Tip360" style="width:auto;">            <div class="Tip_Title">                <em>                    <img src="' + fq_serverSite + 'skin/images/tip_close.jpg" class="Tip_Close"/>                </em>白条/分期            </div>            <div class="Tip_Content" id="Tip_fq0">                <div id="baitiaofenqi" style="position:relative;width:482px;height:330px;">                </div>            </div>        </div>',
        a = ("<div id='c04tip' class='clearfix' style='z-index:20000;position:absolute;width:" + (e + 5) + "px;height:" + (i + 5) + "px;'><div style='position:absolute;margin:5px 0 0 5px;width:" + e + "px;height:" + i + "px;z-index:20001;'>{HTML}</div></div>").replace("{HTML}", s),
        n = $(a);
    n.append(s), $(document.body).prepend(n), $("#Fqfk_Tip").show(), el_top_middle($("#c04tip"), 502, 358), $.ajax({
        url: "http://nfa.jd.com/loadFa.js?aid=2_163_5702",
        dataType: "script",
        cache: !0
...
function showNaBaitiao() {
    var t = 502,
        e = 358,
        i = $("<div id='c04tip' class='clearfix' style='z-index:20000;position:absolute;width:" + (t + 5) + "px;height:" + (e + 5) + "px;'><div style='position:absolute;margin:5px 0 0 5px;width:" + t + "px;height:" + e + "px;z-index:20001;'></div></div>"),
        s = '        <div id="Fqfk_Tip" class="Tip360" style="width:auto;width:500px;height:310px;">            <div class="Tip_Title">                <em><img src="http://jd2008.jd.com/purchase/skin/images/tip_close.jpg" class="Tip_Close"></em> 拿白条            </div>            <div class="Tip_Content" id="nabaitiao"></div>        </div>';
    i.append(s), $(document.body).prepend(i), $("#Fqfk_Tip").show(), el_top_middle($("#c04tip"), 502, 358), $(".Tip_Close").click(function () {
        $("#c04tip").remove()
    }), $.ajax({
        url: "http://nfa.jd.com/loadFa.js?aid=2_163_5480",
        dataType: "script",
        cache: !0
    })
}
    ...
    if (null !== t.packResponseList && t.packResponseList.length > 0) {
        ...
        $("#favorable-suit").show(), $("#favorable-suit .mc").html(suit_TPL.tabs.process(t) + suit_TPL.cons.process(t)), $("#favorable-suit .mc").Jtab({
            ...
            var i = e.attr("packprice"),
                s = e.attr("data-cat"),
                a = e.attr("packlistprice"),
                n = e.attr("discount"),
                o = e.find(".fitting-price"),
                r = e.find(".orign-price"),
                c = e.find(".fitting-saving"),
                d = e.find(".infos .p-name a,.infos .btns a"),
                l = [G.sku];
            "" !== i && "" !== a && (o.html(parseFloat(i).toFixed(2)), r.html(parseFloat(a).toFixed(2)), c.html(parseFloat(n).toFixed(2))), e.find(".suits li[data-sku]").each(function () {
                l.push($(this).attr("data-sku"))
            }), d.attr("href", "http://www.jd.com/suit/show.html?suitId=" + s + "&skuIds=" + l.join(",")), e.find("img[data-src]").each(function () {
                var t = $(this),
                    e = t.attr("data-src");
...
function renew() {
    $.ajax({
        url: "http://d.jd.com/oldfornew/get?skuId=" + pageConfig.product.skuid,
        dataType: "jsonp",
        success: function (t) {
...
function onlineService(t, e, i) {
    ...
    o = s(o);
    var r = $("#store-selector .text").text(),
        c = $("#store-prompt strong").html(),
        d = r + "（" + c + "）";
    d = s(d), e = s(e);
    var l = $("span[class^='star']").attr("class").replace("star sa", ""),
        p = 100;
    try {
    ...
    var m = 100;
    try {
        m = $("#i-comment .rate strong").text().replace("%", "")
    } catch (u) {
    }
    var h = s(pageConfig.product.src),
        f = jQuery.cookie("_recent");
    f || (f = "");
    var g = "";
    try {
...
function setImButton(t) {
    var e = t || G.sku;
    $.ajax({
        url: "http://chat1.jd.com/api/checkChat?",
        data: {
            pid: e,
            returnCharset: "utf-8"
        },
        ...
        success: function (t) {
            if (t) {
                ...
                } else(3 == s || 9 == s) && ($("#online-service").show().find("b").html("联系客服"), $("#j-im").addClass("d-offline").html("<b>留言咨询</b>").attr("title", i + " 客服目前不在线，您可以点击此处给商家留言，并在【我的京东->消息精灵】中查看回复").click(function () {
...
function CombineShare(t) {
    this.$el = t.$el, this.imgs = "string" == typeof t.imgs ? [t.imgs] : t.imgs, this.onbeforeOpen = t.onbeforeOpen ||
    function () {
        ...
        T3: {
            name: "qqWeibo",
            text: "腾讯微博",
            url: "http://share.jd.com/qqweibo/login.action"
        },
        T4: {
            name: "renren",
            text: "人人网",
            url: "http://share.jd.com/renren/login.action"
        },
        T5: {
            name: "kaixin",
            text: "开心网",
            url: "http://share.jd.com/kaixin001/login.action"
        },
        T6: {
            name: "douban",
            text: "豆瓣网",
            url: "http://share.jd.com/douban/login.action"
        }
    }, this.init()
}
...
(function (t) {
    "object" == typeof pageConfig.product && (t.sku = pageConfig.product.skuid, t.key = pageConfig.product.skuidkey, t.url = pageConfig.product.href, t.src = pageConfig.product.src, t.name = pageConfig.product.name, t.mdPerfix = 1 == pageConfig.product.type ? "CR" : "GR", t.mbPerfix = 1 == pageConfig.product.type ? "3C" : "GM", t.mp = pageConfig.product.mp, t.jp = pageConfig.product.jp, t.cat = pageConfig.product.cat, t.orginSku = pageConfig.product.orginSkuid || t.sku, t.isJd = 1e9 > t.sku, t.isPop = t.sku > 1e9, t.isCellphone = 655 == pageConfig.product.cat[2] || 6881 == pageConfig.product.cat[2] || 6882 == pageConfig.product.cat[2], t.isArray = function (t) {
        ...
        var e, i, s, a, n = t.indexOf("?"),
            o = t.substr(0, n),
            r = t.substr(n + 1),
            c = r.split("&"),
            d = c.length,
            l = {};
        for (e = 0; d > e; e++) i = c[e].split("="), s = i[0], a = i[1], l[s] = a;
        return {
            url: o,
            param: l
        }
        ...
        t = t || [], e = e || $("body").eq(0), i = i || "p-comm-", s = s || "(已有{NUM}人评价)", $.ajax({
            ...
            success: function (t) {
                ...
                if (t && t.CommentsCount.length) {
                    ...
                    for (var n = 0; e > n; n++) $("." + i + t.CommentsCount[n].SkuId).find(".star").removeClass("sa5").addClass("sa" + t.CommentsCount[n].AverageScore), $("." + i + t.CommentsCount[n].SkuId).html(s.replace("{NUM}", t.CommentsCount[n].CommentCount)), a && a(t.CommentsCount[n].SkuId, t.CommentsCount[n])
                }
            }
        })
        ...
        for (var i = $(t).parents(e), s = i.find(".master input").attr("wmeprice"), a = i.find("input:checked"), n = a.length, o = i.find(".infos .res-totalprice"), r = i.find(".infos .res-jdprice"), c = 0, d = 0, l = "http://cart.jd.com/cart/dynamic/reBuyForOrderCenter.action?wids={SKUS}&nums={NUMS}", p = i.find(".btn-buy,.J-buy-url"), u = [], m = 0; a.length > m; m++) c += parseFloat(a.eq(m).attr("wmaprice")), d += parseFloat(a.eq(m).attr("wmeprice")), u.push(a.eq(m).attr("skuid"));
        "" == s || 0 >= Number(s) || 0 >= Number($(t).attr("wmeprice")) ? (o.text("暂无报价"), r.text("暂无报价")) : (o.hasClass("saving") || o.text("￥ " + c.toFixed(2)), r.text("￥ " + d.toFixed(2)), p.attr("href", l.replace("{SKUS}", u.join(",")).replace("{NUMS}", u.join(",").replace(/\d+/g, 1))), i.find(".infos .p-name span").html("" + (n - 1)))
        ...
        if ("all" == e) {
            var d = parseInt(n.attr("data-count"));
            n.find("li").show(), r.css("width", 166 * d), d > 4 && n.css("overflow-x", "scroll")
        } else n.find("li").hide(), c.show();
        if (o.removeClass("scurr"), $(t).addClass("scurr"), 1 == !!$(t).attr("data-count")) {
            var l = parseInt($(t).attr("data-count"));
            n.css("overflow-x", 4 >= l ? "hidden" : "scroll"), r.css("width", 166 * l)
        }
        ...
        var i = "http://mercury.jd.com/log.gif?",
            s = "src=" + t.name + "$action=" + t.action;
        ...
        if (/\.css$/.test(t)) a.rel = "stylesheet", a.type = "text/css", a.href = t, i.length ? i[0].appendChild(a) : e.documentElement.appendChild(a);
        else {
        ...
        var e = "",
            i = RegExp("-" + t + "-"),
            s = "-27-28-31-32-67-68-69-70-78-79-42-64-65-66-71-72-73-74-80-81-",
            a = "-2-3-4-44-49-",
            n = "-6-7-41-47-",
            o = "-9-48-60-",
            r = "-15-16-17-18-45-46-61-63-",
            s = "-11-",
            c = "-52-53-54-57-58-59-75-82-83-84-";
        return i.test(s) && (e = "由原厂为您提供服务，官方品质保证，服务无忧"), i.test(a) && (e = "自厂商保修期结束起，延长您爱机的保修时间"), i.test(n) && (e = "提供由于意外事故导致爱机故障的保修服务"), i.test(o) && (e = "爱机故障无需维修，直接免费更换新机"), i.test(r) && (e = "专业工程师上门为您提供安装调试服务"), i.test(s) && (e = "专家在线，远程协助您解决软件使用问题"), i.test(c) && (e = "提供1次屏幕修复，让屏碎不再心碎"), e
        ...
        init: function (t, e) {
            this.seconds = t, this.timer = null, this.callback = e ||
            function () {
            }, this.loopCount()
        },
        loopCount: function () {
            var t = this,
                e = t.formatSeconds(t.seconds);
        ...
        if (i && i.length) {
            for (var s = 0; i.length > s; s++) if (i[s] == t) return e(), !0;
            return !1
        }
        return !1
    }
    ...
    t.fn.floatNav = function (e) {
        ...
        return s.css({
            ...
            var e = t(document).scrollTop(),
                ...
                o = i.targetEle ? t(i.targetEle).offset().top : 1e4;
    ...
    e.prototype = {
        ...
        onScroll: function () {
            var e = t(document).scrollTop(),
                i = this.opts.start || this.$o.offset().top,
                s = this.opts.end || i + this.$o.outerHeight(),
                a = t(window).height();
    ...
    var e = function (e, i, s) {
        this.opts = t.extend({
            ...
            close: !1,
            autoClose: !1
        }, i), this.$obj = t(e), this.callback = s ||
        function () {
        }, this.init()
    };
    e.prototype = {
        ...
        t(this).hover(function () {
            ...
            t(this).find("img").attr("alt", ""), 0 == t("div.zoomdiv").get().length && (t(this).after("<div class='zoomdiv'><img class='bigimg' src='" + c + "'/></div>"), t(this).append("<div class='jqZoomPup'>&nbsp;</div>")), t("div.zoomdiv").width(i.xzoom), t("div.zoomdiv").height(i.yzoom), t("div.zoomdiv").show(), i.lens || t(this).css("cursor", "crosshair"), t(document.body).mousemove(function (s) {
                ...
                if (isNaN(p) | isNaN(l)) {
                    var p = c / o,
                        l = d / r;
                    t("div.jqZoomPup").width(i.xzoom / (1 * p)), t("div.jqZoomPup").height(i.yzoom / (1 * l)), i.lens && t("div.jqZoomPup").css("visibility", "visible")
                }
...
var suit_TPL = {
    ...
    fq_serverSite = "http://jd2008.jd.com/purchase/",
    ...
    Grecommend = function (t, e, i, s, a) {
        this.sku = t, this.rid = e, this.locId = i, this.lim = a || 6, this.pin = readCookie("pin"), this.pid = null === i ? 1 : i.split("-")[0], this.el = s;
        var n = this;
        return 1713 == pageConfig.product.cat[0] ? !1 : ("#tab-hot" === s.selector || "#out-of-stock #noitem-list" === s.selector ? n.init() : $(s.selector).parent().wrap('<div data-lazyload="true"></div>').parent().Jlazyload({
            type: "module"
        }, function () {
            n.init()
        }), void 0)
...
Grecommend.prototype = {
    ...
    get: function (t) {
        ...
        if (pageConfig.product) for (var s = 0; pageConfig.product.cat.length > s; s++) i["c" + (s + 1)] = pageConfig.product.cat[s];
        this.pin && (i.pin = this.pin), $.ajax({
            url: "http://diviner.jd.com/diviner?" + decodeURIComponent($.param(i)),
            dataType: "jsonp",
            scriptCharset: "utf-8",
            success: function (t) {
                e.set(t)
    ...
    set: function (t) {
        function e(t, e) {
            for (var i = t.length / e, s = [], a = 0; i > a; a++) s.push({
                tabs: [],
                increment: null,
                count: e,
                skuids: []
            });
            for (var n = 0, o = 0; t.length > o; o++) 0 == o % e && n++, s[n - 1].tabs.push(t[o]), s[n - 1].increment = n, s[n - 1].skuids.push(t[o].wid);
            return s
        }
        ...
        if (pageConfig.product.GrecommendSkus = [], t.success && t.data && t.data.length > 0) {
            ...
            G.getPriceNum(pageConfig.product.GrecommendSkus, readCookie("ipLoc-djd"), this.el), this.el.find("img").Jlazyload({
                type: "image"
            }), this.setTrackCode(t.impr)
        }
    },
    set1315: function (t) {
        function e(t) {
        ...
        function i(e, i) {
            ...
            $("#pop-box").length > 0 && $("#pop-box").attr("data-ind", e), r.clear().show(e, function () {
                var i = $("#pop-list-" + e),
                    s = i.attr("data-sku"),
                    r = i.find("a.curr").attr("title");
                l(e), n.del(), d.get(e), o(e, a || null, t), c.get(s, a || r, e, p)
            })
        }
        ...
        var s = $("#tab-hot"),
            ...
            l = function (t) {
                ...
                $("#p-selected-ok").unbind("click").bind("click", function () {
                    var e = $("#pop-box");
                    if (e.find("#p-scroll .curr").attr("title"), 1 > $("#pop-box .curr").length) c.setTips('<p id="p-noselected">请选择颜色</p>');
                    else if (1 > $("#pop-box .selected").length && !$("#p-size").hasClass("nosizes")) c.setTips('<p id="p-noselected">请选择尺码</p>');
                    else {
                        a.set(t, $("#pop-list-" + t).attr("data-res")), r.hide().clear();
                        var i = $("#pop-list-" + t),
                            s = i.attr("data-res").split("|"),
                            n = s[0],
                            o = s[3],
                            d = s[4],
                            l = i.find(".p-price img");
                        l.attr("src"), i.find("input:checkbox").attr({
                            skuid: n,
                            wmaprice: o,
                            wmeprice: d,
                            checked: !0
    ...
    setTrackCode: function (t) {
        var e = this.el.find("li"),
            i = this,
            s = "&m=UA-J2011-1&ref=" + encodeURIComponent(document.referrer);
        e.each(function () {
...
var Recommend = {
        ...
        renderRecoFittingsHTML: function () {
            var t = G.sku,
                e = 6728 == G.cat[0] || 653 == G.cat[1] || 830 == G.cat[1],
                i = "-672-6864-1105-717-720-718-719-798-",
                s = RegExp("-" + G.cat[2] + "-").test(i);
            return !G.isJd && e ? !1 : (655 == G.cat[2] ? $.ajax({
                url: "http://rs.jd.com/accessorie/newServiceWhite.jsonp?sku=" + G.sku + "&callback=Recommend.cbNewFittings",
                dataType: "script",
                cache: !0,
                scriptCharset: "utf-8"
            }) : 830 == G.cat[1] ? $.ajax({
                url: "http://rs.jd.com/accessorie/accessoryByAccessory.jsonp?sku=" + G.sku + "&callback=Recommend.cbNewFittings",
                dataType: "script",
                cache: !0,
                scriptCharset: "utf-8"
            }) : G.cat[2] > 830 && 835 > G.cat[2] || 5012 === G.cat[2] ? $.ajax({
                url: "http://misc.360buyimg.com/product/js/2012/fittingsCamera.js?ver=20140424",
                dataType: "script",
                cache: !0,
                success: function () {
            ...
            }) : 6728 == G.cat[0] && G.isJd ? $.ajax({
                url: "http://misc.360buyimg.com/product/js/2012/fittingsAuto.js?ver=20140424",
                dataType: "script",
                cache: !0
            }) : $.getJSONP("http://d.jd.com/fittingInfo/get?skuId=" + t + "&callback=Recommend.cbRecoFittings"), void 0)
        },
        cbNewFittings: function (t) {
            ...
            if (pageConfig.product.cbNewFittings = [pageConfig.product.skuid], pageConfig.setFittingsClk = function (t, e, i, s, a) {
                ...
                if (e.attr("loaded", "true").html(s.cons.process(t)), 830 != pageConfig.product.cat[1]) {
                    for (var a = 0; t.accessoryList.length > a; a++) t.accessoryList[a].accessoryList.length = 4, t.accessoryList[a].accessoryList[0].thirdType = t.accessoryList[a].thirdTypeId, t.accessoryList[a].accessoryList[0].thirdName = t.accessoryList[a].thirdName, i.accessoryList.push(t.accessoryList[a].accessoryList[0]), i.isExtra = !1;
                ...
                $("#newFittign-tab").prepend(s.tabs.process(t)).Jtab({
                    ...
                    var n = $("#newFittign-tab .suits"),
                        o = $("#tab-cat-" + a).attr("data-cat").split("|")[1],
                        r = $("#tab-cat-" + a).attr("data-cat").split("|")[0],
                        c = $("#more-fitting-link a");
                    if (830 != G.cat[1]) if (c.attr("href", "http://rs.jd.com/accessorie/center.html?sku=" + G.sku + "&thirdTypeId=" + o).html("进入" + r), n.scrollLeft(0), 0 !== a) {
                        if ("1" == $("#newFitting-" + a).attr("loaded")) return;
        ...
        cbRecoFittings: function (t) {
            ...
            pageConfig.product.cbRecoFittings = [pageConfig.product.skuid], t && t.fittings && t.fittings.length > 0 && (e.attr("loaded", "true").html('<ul class="stab lh">' + recoFittings_TPL.tabs.process(t) + '</ul><div class="stabcon">' + recoFittings_TPL.cons.process(t) + "</div>"), this.switchTab("#th-fitting"), G.removeLastAdd(), G.getPriceNum(pageConfig.product.cbRecoFittings, readCookie("ipLoc-djd"), e, null, function (t, i) {
                ...
                name: "tjpj",
                action: "0",
                csku: pageConfig.product.cbRecoFittings,
                sku: G.sku
            }))
        }
    },
        ...
        setBuyLink: function () {
            ...
            t.targetLink.each(function () {
                var e, i, s = $(this),
                    ...
                    n = a.split("?")[1];
                (function () {
                    for (var o = 0; t.matchCountKey.length > o; o++) if (i = RegExp(t.matchCountKey[o] + "=\\d+"), i.test(n)) return e = a.replace(i, t.matchCountKey[o] + "=" + t.count), s.attr("href", e), !1
                })()
...
var Refresh = {
    ...
    CommentListNew = {
        ...
        bindReply: function () {
            ...
            this.commList.find(".btn-toggle").unbind("click").bind("click", function () {
                ...
                var i = $(e.target),
                    ...
                    n = i.attr("data-nickname"),
                    o = i.parents(".reply-input").find("input").val(),
                    r = {};
                if (i.hasClass("reply-btn")) return t.currReply = i, o = o.replace(/</g, "<").replace(/>/g, ">"), a = i.hasClass("reply-btn-lz") ? "" : a, r = {
                    guid: s,
                    content: o,
                    replyId: a,
                    nickname: n
        ...
        setReplyItem: function (t) {
            var e, i = this,
                ...
                a = s.find(".reply-lz"),
                n = i.currReply.parents(".reply-list").eq(0),
                o = n.find(".parentReplyFrom"),
                r = this.currReply.parents(".item-reply").eq(0),
                c = a.next();
            ...
            var d = '<div class="item-reply hide-default" data-index="${commentReply.index}" data-name="${commentReply.nickname}" data-uid="${commentReply.uid}">          <strong>${commentReply.index}</strong>          <div class="reply-list">              <div class="reply-con">                  <span class="u-name">                      ${commentReply.nickname}{if commentReply.userClient==99}<b></b>{/if}                      {if parseInt(commentReply.parentId, 10)>0}                          <em>回复</em>                          {if typeof replyHTML!=="undefined"}                              ${replyHTML}                          {else}                              <a class="parentReplyTo" target="_blank" href="#none">{if parseInt(commentReply.parentId, 10)<0}{else}${toname}{/if}</a>                          {/if}                      {/if}：                  </span>                  <span class="u-con">${commentReply.content}</span>              </div>              <div class="reply-meta">                  <span class="reply-left fl">${commentReply.creationTimeString.replace(/:[0-9][0-9]$/, "")}</span>                  <a class="btn-toggle p-bfc" data-id="${commentReply.id}" href="#none">回复</a>              </div>              <div id="btn-toggle-${_type}-${commentReply.id}" class="replay-form none">                  <div class="arrow">                      <em>◆</em><span>◆</span>                  </div>                  <div class="reply-wrap">                      <p><em>回复</em> <span class="u-name">${commentReply.nickname}：</span></p>                      <div class="reply-input">                          <div class="fl"><input type="text" /></div>                          <a href="#none" class="reply-btn btn-gray p-bfc" data-guid="${commentReply.guid}" data-replyId="${commentReply.id}">回复</a>                          <div class="clr"></div>                      </div>                  </div>              </div>          </div>      </div>';
            a.after($(d.process(t)).fadeIn()), s.find(".btns .btn-reply em").html(e), this.currReply.hasClass("reply-btn-lz") || this.currReply.parents(".replay-form").eq(0).hide(), this.currReply.parents(".reply-input").find("input").val(""), this.bindReply()
        },
        getData: function (t, e, i, s) {
            this.wrap = t, this.type = e || 0, this.page = i, this.sType = s || 3, this.commRateLoaded = !1, this.url = "http://s.club.jd.com/productpage/p-{skuId}-s-{commType}-t-{sortType}-p-{currPage}.html", this.url = this.url.replace("{skuId}", this.sku).replace("{commType}", this.type).replace("{sortType}", this.sType).replace("{currPage}", this.page), $.getJSONP(this.url + "?callback=CommentListNew.setData")
        },
    ...
    Discuss = {
        getData: function (t, e) {
            var i = this,
                s = "http://club.jd.com/clubservice/newcomment-",
                a = "",
                n = e;
            switch (this.obj = n, t) {
                case 0:
        ...
        getDiscussComment: function () {
            var t = this,
                e = "http://club.jd.com/clubservice/newcomment-Commp." + G.cat[2] + "-" + G.sku + ".html";
            $.ajax({
                url: e,
                dataType: "jsonp",
                success: function (e) {
        ...
        setDiscussComment: function (t) {
            var e = $("#discuss-comment"),
                i = '<tbody>    {for item in Comments}    <tr>        <td class="col1">            <div class="topic">                <b class="icon lun"></b>                <a href="http://club.jd.com/CommunityGroupDetail/${item.id}_1.html" target="_blank">${item.title}</a>            </div>        </td>        <td class="col2">${item.replyCount}/${item.viewCount}</td>        <td class="col3">            <div class="u-name">                {if item.uRemark}${item.uRemark}{else}${item.nickname}{/if}            </div>        </td>        <td class="col4">${item.creationTime}</td>    </tr>    {/for}</tbody>';
    ...
    Consult = {
            ...
            window.fetchJSON_Consult = function (t) {
                if (e.html(consult_TPL.process(t)), void 0 !== pageConfig.im) {
                    var i = pageConfig.im,
                        s = i.code,
                        a = i.seller;
                    if (1 == s) $("#j-im-extra").css("display", "inline-block"), $("#j-im-extra").attr("title", a + " 联系客服"), $("#j-im-extra").click(function () {
                    ...
                    } else(3 == s || 9 == s) && ($("#j-im-extra").css("display", "inline-block").find("b").html("给客服留言"), $("#j-im-extra").addClass("d-offline").html("<b>留言咨询</b>").attr("title", a + " 客服目前不在线，您可以点击此处给商家留言，并在【我的京东->消息精灵】中查看回复").click(function () {
        ...
        setExtraData: function (t, e) {
            $.ajax({
                url: "http://d.jd.com/hotwords/get?Position=A-product-0" + (t - 3),
                dataType: "jsonp",
                cache: !0,
                success: function (i) {
                    if (null != i) {
            ...
            $.ajax({
                ...
                success: function (t) {
                    ...
                    if (t.length > 0) {
                        ...
                        if ($("#consult .tabcon:visible").html(n + "" + consult_search_TPL.process(t[0]) + e), 0 >= t[0].list.length || 0 >= t[0].total) return !1;
    ...
    Repository = {
        ...
        setKeywords: function (t) {
            ...
            if (null !== t && t.length > 0) {
                for (var a = 0; t.length > a; a++) t[a].id = "wiki-keyword-" + a, this.content.html($(".detail-content").eq(0).html().replace(RegExp(t[a].keyword), '<span data-id="' + t[a].knid + '" class="wiki-words" id="' + "wiki-keyword-" + a + '" style="border-bottom:1px dotted;padding-bottom:2px;">' + t[a].keyword + "</span>")), s = i.process(t[a]), e.append($('<div class="wiki-pop hide" id="des-wiki-keyword-' + a + '">' + s + "</div>"));
    ...
    EvaluateGradeNew = {
        ...
        setGradeDetail: function (t) {
            this.data = t;
            var e = '<div id="evaluate-detail" class="m">    {if f23<1}        <div style="padding-bottom:10px">卖家暂未收到任何评价</div><style type="text/css">#brand-bar-pop #online-service{border-top:1px solid #ddd;}</style>    {else}        <div class="mt"><style type="text/css">#brand-bar-pop #evaluate{display:block;}</style>            <div class="fl">评分明细</div>            <div class="p-bfc">与行业相比</div>        </div>        <div class="mc">            <dl>                <dt>商品评分：</dt>                <dd>                    {if parseFloat(f46) <= 0}                    <span>-----</span>                    {else}                    <span class="eva-grade" title="${f20}">${f20.toFixed(10).substr(0,4)}<b>分</b></span>                    <span class="eva-percent ${EvaluateGradeNew.calcTrends(1).trends}" title="${EvaluateGradeNew.calcTrends(1).title}"><s></s>{if EvaluateGradeNew.calcTrends(1)=="eva-eq"}-----{else}${(f46*100).toFixed(10).substr(0,4)}%{/if}</span>                    {/if}                </dd>            </dl>            <dl>                <dt>服务评分：</dt>                <dd>                    {if parseFloat(f47) <= 0}                    <span>-----</span>                    {else}                    <span class="eva-grade" title="${f21}">${f21.toFixed(10).substr(0,4)}<b>分</b></span>                    <span class="eva-percent ${EvaluateGradeNew.calcTrends(2).trends}" title="${EvaluateGradeNew.calcTrends(2).title}"><s></s>{if EvaluateGradeNew.calcTrends(2)=="eva-eq"}-----{else}${(f47*100).toFixed(10).substr(0,4)}%{/if}</span>                    {/if}                </dd>            </dl>            <dl>                <dt>时效评分：</dt>                <dd>                    {if parseFloat(f48) <= 0}                    <span>-----</span>                    {else}                    <span class="eva-grade" title="${f22}">${f22.toFixed(10).substr(0,4)}<b>分</b></span>                    <span class="eva-percent ${EvaluateGradeNew.calcTrends(3).trends}" title="${EvaluateGradeNew.calcTrends(3).title}"><s></s>{if EvaluateGradeNew.calcTrends(3)=="eva-eq"}-----{else}${(f48*100).toFixed(10).substr(0,4)}%{/if}</span>                    {/if}                </dd>            </dl><div class="line"></div>        </div>    {/if}</div>';
            if (null !== t) {
...
var JdService = {
        ...
        get: function () {
            var t = this;
            $.ajax({
                url: "http://d.jd.com/yanbao2/get?skuId=" + this.sku,
                dataType: "jsonp",
                success: function (e) {
                    e && t.set(e)
                }
        ...
        set: function (t) {
            ...
            for (e = 0; a > e; e++) i = RegExp("-" + t[e].sortId + "-"), i.test("-2-3-4-44-49-") ? (n.list[0] || (n.list[0] = {}, n.list[0].items = [], n.list[0].cName = "yb-item-cat-r0"), n.list[0].items.push(t[e])) : i.test("-6-7-41-47--") ? (n.list[1] || (n.list[1] = {}, n.list[1].items = [], n.list[1].cName = "yb-item-cat-r1"), n.list[1].items.push(t[e])) : i.test("-9-48-60-") ? (n.list[2] || (n.list[2] = {}, n.list[2].items = [], n.list[2].cName = "yb-item-cat-r2"), n.list[2].items.push(t[e])) : i.test("-11-50-") ? (n.list[3] || (n.list[3] = {}, n.list[3].items = [], n.list[3].cName = "yb-item-cat-r3"), n.list[3].items.push(t[e])) : i.test("-15-16-17-18-45-46-61-63-") ? (n.list[4] || (n.list[4] = {}, n.list[4].items = [], n.list[4].cName = "yb-item-cat-r4"), n.list[4].items.push(t[e])) : i.test("-20-21-22-76-77-85-86-87-") ? (n.list[5] || (n.list[5] = {}, n.list[5].items = [], n.list[5].cName = "yb-item-cat-r5"), n.list[5].items.push(t[e])) : i.test("-27-28-31-32-67-68-69-70-78-79-") ? (n.list[6] || (n.list[6] = {}, n.list[6].items = [], n.list[6].cName = "yb-item-cat-r6"), n.list[6].items.push(t[e])) : i.test("-42-64-65-66-71-72-73-74-80-81-") ? (n.list[7] || (n.list[7] = {}, n.list[7].items = [], n.list[7].cName = "yb-item-cat-r7"), n.list[7].items.push(t[e])) : i.test("-52-53-54-57-58-59-75-82-83-84-") ? (n.list[8] || (n.list[8] = {}, n.list[8].items = [], n.list[8].cName = "yb-item-cat-r8"), n.list[8].items.push(t[e])) : (n.list[9] || (n.list[9] = {}, n.list[9].items = [], n.list[9].cName = "yb-item-cat-r9"), n.list[9].items.push(t[e]));
            if (s.list.length > 0) {
                this.$el.html(this.yb_TPL.process(n)).show(), pageConfig.product.hasYbInfo = !0;
                var o = this.$el.find(".yb-item-cat");
                o.hover(function () {
                    ...
                    o.each(function () {
                        var t = $(this).width();
                        t > 0 && $(this).find(".item").css("width", t)
                    })
                }, 0)
            } else this.$el.html("");
            this.bindEvent(), this.itemCount = s.list.length, this.callback.call(this)
        },
        addItem: function (t) {
            this.resObj["p" + t] = t
        },
        ...
        calResult: function () {
            var t = this.$el.find(".selected"),
                e = [];
            return t.each(function () {
                var t = $(this).find(".yb-item"),
                    i = t.attr("data-sku");
                i && e.push(i)
            }), "function" == typeof this.onSelected ? this.onSelected.apply(this, [e, this.currSku, this.currEl]) : void 0
        }
    },
    NotifyPop = {
...
(function () {
    ...
    var t = "-4835-4836-4833-7073-9393-12276-12278-12279-",
        e = G.cat[2];
    RegExp("-" + e + "-").test(t) && $("#choose-amount").hide(), (4835 == e || 4836 == e) && (setAmount.urlPerfix = "http://card.jd.com/order/order_place.action?", setAmount.data = null, setAmount.data = {
        skuId: G.sku
    ...
    var t = "http://eve.jd.com/redirect.action?wid=" + G.sku + "&btype=0&r=" + Math.random(),
        e = $("#InitCartUrl");
    e.attr({
        href: t,
        "data-origin": encodeURIComponent(t)
    })
}), G.onAttr("isSelfService_17", function () {
    var t = $("#buy-num");
    t.attr("disabled", "true"), setAmount = {}
}), G.onAttr("isKO", function () {
    var t = $("#buy-num");
    t.attr("disabled", "true"), setAmount = {}, pageConfig.serviceYB = "disabled"
}), function () {
    var t = function () {
        var t = "";
        try {
    ...
    JDS = window.JDS || {}, JDS.strpos = function (t, e, i) {
        ...
        parseUri: function (t) {
            for (var e = this.options, i = e.parser[e.strictMode ? "strict" : "loose"].exec(t), s = {}, a = 14; a--;) s[e.key[a]] = i[a] || "";
        ...
        i = function (t) {
            for (var i = 0, s = e.length; s > i; i++) {
                var a = e[i].d,
                    ...
                    o = t.getHost(),
                    r = t.getQueryParam(n);
                if (!JDS.strpos(o, "360buy") && JDS.strpos(o, a) && t.isQueryParam(n)) return {
                    d: a,
                    q: n,
                    k: r
                }
    ...
    getThickBox: function (t, e) {
        function i() {
            ...
            for (var i = 0; t.length > i; i++) e += '<li class="' + (0 === i ? "selected" : "") + '"><a href="#none"><img src="' + t[i].replace(/\/n\d/, "/n4") + '" alt="" /><s></s></a></li>';
            return e
        }
        ...
        function s() {
            var t = a.shareMap,
                e = "";
            for (var i in t) e += '<label title="' + t[i].text + '" for="share-' + t[i].name + '"><input value="' + i.replace("T", "") + '" id="share-' + t[i].name + '" type="checkbox"><em id="share-ico-' + t[i].name + '">' + t[i].text + "</em></label>";
            return e
        }
    ...
    bindEvent: function () {
        var t = this,
            e = this.wrap,
            i = e.find(".share-btn-ok"),
            s = e.find(".share-btn-fail,.share-btn-rebind"),
            a = e.find(".share-img-wrap"),
            n = $("#share-img-prev"),
            o = $("#share-img-next"),
            r = a.find("li");
    ...
    updateCount: function (t) {
        ...
        var e = t.val(),
            i = e.replace(/[一-龥]/g, "jd").length,
            s = this.wrap.find(".share-count"),
            a = s.find("em"),
            n = 100;
    ...
    getBindStatus: function () {
        var t = this;
        $.ajax({
            url: "http://share.jd.com/share/getBindStatus.action",
            dataType: "jsonp",
            success: function (e) {
    ...
    setBindStatus: function (t) {
        for (var e, i, s, a = 0; t.length > a; a++) e = t[a].name, i = t[a].status, s = t[a].type, 1 === i && (this.wrap.find("#share-ico-" + e).addClass("actived"), this.wrap.find("#share-" + e).attr("checked", !0))
    },
    goShare: function () {
        var t = this,
            e = this.wrap.find("dd input:checked"),
            i = this.wrap.find(".share-img-wrap .selected img").attr("src"),
            s = this.wrap.find("#share-text").val(),
            a = [],
            n = this.shareParam;
        n.content = s, n.imgUrl = i, e.each(function () {
            ...
            url: "http://share.jd.com/share/shareItem.action",
            dataType: "jsonp",
            data: n,
            success: function (e) {
                var i = [],
                ...
                if (e && e.code !== void 0 && (-1 === e.code && t.getThickBox(3), 0 === e.code)) {
                    i = e.status.split(",");
                    for (var a = 0; i.length > a; a++) s.push(t.shareMap["T" + i[a]].text);
    ...
    var e, i = "http://cart.jd.com/cart/dynamic/gateForSubFlow.action?wids=" + G.sku + "&nums=1&subType=25",
        s = $("#choose-btns"),
        a = s.find("#choose-btn-easybuy,#choose-btn-divide"),
        n = s.find("#choose-btn-append"),
        o = $("#nav-minicart"),
    ...
    t.prepend('<div id="oversea-purchase" class="m"><em><img src="' + e + '" alt="海外直购-认证商家" /></em></div>'), pageConfig.isOverseaPurchase = !0
}), function () {
    function t() {
    ...
    pageConfig.product.havestock === void 0 ? (s = "", a = "http://cart.gift.jd.com/cart/addGiftToCart.action?pid=" + pageConfig.product.skuid + "&pcount=" + $("#buy-num").val() + "&ptype=1") : (s = pageConfig.product.havestock ? "" : "disabled", pageConfig.product.havestock ? (s = "", a = "http://cart.gift.jd.com/cart/addGiftToCart.action?pid=" + pageConfig.product.skuid + "&pcount=" + $("#buy-num").val() + "&ptype=1") : (s = "disabled", a = "#none")), 6980 == G.cat[2] && $('#product-detail [data-widget="tab-item"]').eq(3).hide(), $("#online-service").find("b").html("联系客服"), $("#comments-list li").eq(4).html('<a href="javascript:;">有晒单的评价<em>(0)</em></a>'), $("body").addClass("cat-1-" + G.cat[0] + " cat-2-" + G.cat[1] + " cat-3-" + G.cat[2] + " item-" + G.sku), G.onAttr("HYKHSP-2", function () {
        ...
        if (t && t.CommentCount !== void 0) {
            if (e.removeClass("sa0").addClass("sa" + t.AverageScore), 6980 === G.cat[2]) return !1;
            i.html("(已有" + t.CommentCount + "人评价)").css("float", "left"), t.CommentCount > 0 && s.find("a").append('<span class="hl_blue"> (' + t.CommentCount + ") </span>")
        } else e.removeClass("sa0").addClass("sa5"), i.html("(已有0人评价)").css("float", "left")
    }), function () {
        if ("disabled" == pageConfig.serviceYB) return !1;
        ...
        JdService.init({
            onSelected: function (n) {
                var o = "&ybId=" + n.join(","),
                    r = $("#buy-num").val(),
                    c = [],
                    d = $("#choose-btn-qiang a");
                if (n.length > 0) {
                    t.attr("href", e.replace(/pcount=\d+/, "pcount=" + r) + o), i.parent().show();
                    for (var l = 0; n.length > l; l++) c.push("<strong>“" + $("#yb-pid-" + n[l]).text() + "”</strong>");
                    i.html((s ? s + "，" : "") + c.join("，"))
                } else t.attr("href", e.replace(/pcount=\d+/, "pcount=" + r)), i.html(s);
                d.length && !a && (a = d.attr("href")), d.length && (n.length > 0 ? d.attr("href", a + o) : d.attr("href", a))
            }
        })
    }(), $(".jqzoom").jqueryzoom({
        xzoom: 400,
    ...
    if ($('#product-detail [data-widget="tab-item"]').find("a").addClass("toggle-link"), function () {
            function t(t) {
                var e = $(window).height(),
                    i = $("body").scrollTop() || $("html").scrollTop(),
                    s = t.offset().top;
                return e + i > s && s > i
            }

            var e, i, s = $(".detail-content"),
                a = s.find('[name^="detail-tag-id-"]'),
                l = [],
                p = $('#product-detail [data-widget="tab-item"]'),
                u = p.eq(0);
            return 1 > a.length ? !1 : (p.find("a").addClass("toggle-link"), o = function () {
                return 1 > a.length ? !1 : (u.addClass("p-tab"), 1 > u.find("a>s").length && u.find("a").append("<s></s>"), u.mouseover(function () {
                    $(this).addClass("hover")
                }), 1 > u.find(".sub-item").length && (a.each(function () {
                    var t = $(this).attr("id"),
                        e = $(this).attr("text");
                    l.push('<li data-id="' + t + '"><a data-id="#' + t + '" href="#' + t + '">' + e + "</a></li>")
                }), u.append('<ul class="hide sub-item">' + l.join("") + "</ul>"), e = u.children(), i = u.find("li"), u.find(".sub-item a").unbind("click").bind("click", function (t) {
                    $(this).text();
                    var e = $(this).attr("data-id"),
                        s = e.replace("#detail-tag-id-", "");
                ...
                u.unbind("mouseover mouseenter mouseout").removeClass("hover"), u.children("a").html("商品介绍<s></s>"), pageConfig.detailListInited = !1
            }, r = function () {
                u.find(".toggle-link").eq(0).html("商品介绍<s></s>")
            }, c = function () {
                u.addClass("hover")
            }, d = function () {
                u.removeClass("hover")
        ...
        var l = new pageConfig.FN_InitSidebar,
            p = "98523";
        832 === G.cat[2] && (p = "737542"), l.addItem('<a class="research" target="_blank" href="http://surveys.jd.com/index.php?r=survey/index/sid/' + p + '/lang/zh-Hans"><b></b>调查问卷</a>'), l.setTop(), l.scroll()
    }
    if (setImButton(G.sku), 1319 === G.cat[0] && $.ajax({
        ...
        if ("baidu" == searchEngineSource.d) {
            ...
            u = /ie=utf-8/.test(m) ? "&encode=utf-8" : "&encode=gbk"
        } else u = RegExp(searchEngineSource.d).test("soso#sogou") ? "&encode=gbk" : "&encode=utf-8";
        pageConfig.disabledSeoBanner = !0, seoBanner(searchEngineSource, u)
    }
    (function () {
        var t = ["2_163_817", "2_163_818", "2_232_3431", "2_163_3743"];
        pageConfig.disabledSeoBanner || (t.push("2_163_5395"), t.push("2_163_5394")), 1315 === G.cat[0] && $("#Ad2_100_2272").length > 0 && t.push("2_100_2272"), G.isPop && t.push("2_601_3951"), $.ajax({
            url: "http://nfa.jd.com/loadFa_toJson.js?aid=" + t.join("-") + "&ver=20131107",
            dataType: "script",
            cache: !0
        }), insertScript("http://static.360buyimg.com/gemini/gemini/gemini_v2.2.1.js", {
            id: "1399174259281",
            name: "gemini_divide_script",
            charset: "utf-8",
            divideType: "MODULE_INJECT",
            param: "[{t:'xiaoyumi'}]"
        })
        ...
        JA && JA.tracker.ngloader("item.010002", {
            sku: G.sku,
            jp: pageConfig.product.jp
        })
    }), $("#choose-btn-coll b").click(function () {
        JA && JA.tracker.ngloader("item.010003", {
            sku: G.sku
        })
    }), function () {
        var t = pageConfig.product.videoPath,
            e = $(".detail-content"),
            i = $("#letv");
        if (t && 1 > i.length) {
            var s = "http://yuntv.letv.com/bcloud.html?uu=abcde12345&vu=" + t + "&pu=12345abcde&auto_play=0&width=750&height=422";
            e.before('<div id="letv"><iframe id="le-video" data-lazyload="' + s + '" frameborder="0" scrolling="no" style="display:block; width:750px; height:422px; margin:0 auto;"></iframe></div>'), $("#letv iframe").Jlazyload({
                type: "image"
            })
        }
    }(), function () {
        var t = $("#itemover-related-list"),
            e = pageConfig.compatible && pageConfig.wideVersion ? 12 : 9;
        ...
        var t = $("#preview .spec-items li img"),
            e = [],
            i = $("#share-list li");
        t.each(function () {
            var t = $(this).attr("src");
        ...
        var t = $("#consult-search .form"),
            e = $("#consult"),
            i = pageConfig.wideVersion && pageConfig.compatible,
        ...
        var t = $("#comments-list .mt"),
            e = RegExp("-" + G.sku + "-"),
            i = "-1155902-1133857-1169454-1142209-1196479-";
        e.test(i) && t.append('<div class="p-bfc ar"><span class="join-discuss" onclick="$(\'._base_ygg_yqb\').trigger(\'click\')" href="#none">加入讨论</span></div>')
    }()
});
var geminiCustomizedDot = geminiCustomizedDot || [],
    MBuy = {
        init: function () {
            this.chooseBtn = $("#choose-btns"), pageConfig.isOverseaPurchase || this.setQrcode()
        },
        setQrcode: function () {
            var t = this,
                e = '<div id="m-buy" clstag="shangpin|keycount|product|btn-erweima">    <div class="mt">客户端首次下单</div>    <div id="m-countdown">        <strong class="hl_red">送5元京券</strong>    </div>    <div id="m-qrcode" class="hide">        <span class="close" onclick="$(\'#m-buy\').removeClass(\'hover\')"></span>        <span class="arr"></span>        <div class="m-qrcode-wrap">            <strong>客户端首单满59送5元京券低价秒杀商品抢不停</strong>            <div id="m-qrcode-box">                <img src="http://misc.360buyimg.com/lib/img/e/blank.gif" width="155" height="155" />            </div>        </div>    </div></div>';
            return $("#m-buy").length > 0 ? !1 : (this.chooseBtn.append(e), this.mBuy = $("#m-buy"), this.mt = this.mBuy.find(".mt"), this.mBuy.Jdropdown({
                delay: 200,
                event: "click"
            }, function () {
                "true" !== t.mBuy.attr("loaded") && ($.ajax({
                    url: "http://misc.360buyimg.com/product/js/2012/qrcode.js?ver=20140527",
                    dataType: "script",
                    scriptCharset: "gb2312",
                    cache: !0
                }), t.mBuy.attr("loaded", "true"))
            }), void 0)
        },
        setProm: function (t) {
            var e = this.mBuy.find("#m-countdown");
            if (!(t && t.indexOf(".") > -1)) return this.mt.html("客户端首次下单"), e.html('<strong class="hl_red">送5元京券</strong>'), void 0;
            t = t.split(",");
...
(function () {
    var t = RegExp("-" + G.cat[2] + "-"),
        e = "-1195-6980-6151-6152-1444-7052-7054-7057-9435-";
...
ABTest.prototype = {
    test: function () {
        ...
        function e(e) {
            for (var s = e, a = e.length, n = 0; a > n; n++) 0;
            t()
        }
        ...
        window.collectUUUID = function (t) {
            ...
            url: "http://nfa.jd.com/loadFa_toJson.js?aid=2_163_4827-2_163_4828",
            dataType: "jsonp",
            cache: !0,
            success: function () {
            }
