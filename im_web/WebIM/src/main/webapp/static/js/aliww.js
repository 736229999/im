...
function onlinewangWangSend(c, g, b, a, e, f) {
    ...
    if (a != "" || a != null || a != "undefined") {
        ...
        if (window.aliwangwangSendmsgShowFrame) {
            if (d) {
                alert(a + " isDOM");
                document.getElementById("aliwangwangSendmsgShowFrame").src = "http://www.im.alisoft.com/webim/common/online_dispatch_v6.html?fromsite=" + c + "&fromid=" + g + "&sendsite=" + b + "&sendid=" + a + "&imstatus=" + e + "&moreProperties=" + escape(f)
            } else {
                alert(a + " bbbbb");
                window.aliwangwangSendmsgShowFrame.location = "http://www.im.alisoft.com/webim/common/online_dispatch_v6.html?fromsite=" + c + "&fromid=" + g + "&sendsite=" + b + "&sendid=" + a + "&imstatus=" + e + "&moreProperties=" + escape(f)
            }
        } else {
            alert(a);
