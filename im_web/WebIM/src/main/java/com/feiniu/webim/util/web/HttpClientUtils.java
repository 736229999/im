...
public class HttpClientUtils {
    ...
    public static String excutePostJson(String url, Map<String, Object> params) throws IOException {
        ...
        try {
            ...
            */
            String paramsString = JSONUtil.toJsonString(params);
            StringEntity stringEntity = new StringEntity(paramsString, Consts.UTF_8);
//            UrlEncodedFormEntity entity = new UrlEncodedFormEntity(formparams, Consts.UTF_8);
    ...
    public static void main(String[] args) throws Exception {
        ...
        map.put("sid", "ZxojLTPuRSoiqsdfJnhrgg%3D%3D");
        map.put("token", "g2ybwYYdaKZsGstUMg0nxdvSLM3%2BRugk5UZyxLanhI0M2uOQkh8uGu5kJyT61AdS2F43NNq4UKyL47U%2FNU%2BX5w%3D%3D");

        System.out.println(executeGet("local.beta1.fn", "/webim/vender",map));
    }
}
