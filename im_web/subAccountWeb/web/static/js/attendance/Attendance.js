...
var attendanceStatistics = {
    ...
    initData: function () {
        var self = this;
        $tempdata = $('tempdata');
        self.dataManager.merchantID = $tempdata.data('merchantid');
        self.dataManager.subMerchantIDList = $tempdata.data('subaccountlist');
        self.dataManager.subMerchantCount = self.dataManager.subMerchantIDList.length;
        searchWithParams(1);
        $tempdata.remove();
    },
    ...
    initUI: function () {
        ...
        (function initTabs() {
            $('.ui-tab>.tab-nav>.tab-nav-item').click(function () {
                var $this = $(this);
                ...
                if (!$this.hasClass('cur')) {
                    ...
                    var refTab = $this.attr('rel');
                    $('.tab-panel-item').hide().filter('#' + refTab).show();
                }
            });
        })();
    },
    ...
    bindUI: function () {
        ...
        $('#workLoadTabPage').click(function () {
            ...
            self.flushBackParams();
            self.updateUIbyParams();
            if (!self.dataManager.isInited) {
                searchWithParams(1);
                self.dataManager.isInited = true;
            }
        });
    ...
    getParams: function () {
        ...
        return $.extend({}, {
            ...
            merchantID: self.dataManager.merchantID,
