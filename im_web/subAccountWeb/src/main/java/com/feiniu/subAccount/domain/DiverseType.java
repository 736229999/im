...
public class DiverseType {
    @Id
    @GenericGenerator(name = "diverseTypeGenerator", strategy = "sequence",
            parameters = {@org.hibernate.annotations.Parameter(name= "sequence",value="seq_diverse_type")})
    @GeneratedValue(generator = "diverseTypeGenerator")
