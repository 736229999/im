...
public class WorkLoadMessageDaoImpl implements WorkLoadMessageDao {
    ...
    public List<WorkLoadInfo> getWorkLoadListByTime(long startTime, long endTime, String merchantId) {
        ...
        sql = " SELECT PPD.* ,  " +
                ...
                "    dde.G_GROUP_NAME  " +
                "  FROM  " +
                "    T_SERVICE_GROUP_MAPPING ddd  " +
                "  LEFT JOIN T_SERVICE_GROUP dde ON DDD.S_GROUP_ID = DDE.G_GROUP_ID  " +
                " ) PD ON PC.I_SUBMERCHANT_ID = PD.S_SUBACCOUNT_ID  " +
                " ) ) PPD  " +
                " LEFT JOIN (  " +
        ...
        for (Object obj : query.list()) {
            if (obj == null) {
                ...
                if (res[8] == null)
                    ...
                    index.setSubMerchantGroup(String.valueOf(res[8]));
    ...
    @Override
    public List<SubMerchantInfo> getAllDirectorSubMerchantInfoList(){
        String sql;
        Query query;
        Session session = sessionFactory.getCurrentSession();
        ...
        return session.createSQLQuery(sql).
                ...
                addScalar("merchantId", Hibernate.LONG).
                addScalar("username", Hibernate.STRING).
                addScalar("truename", Hibernate.STRING).
                addScalar("memberType", Hibernate.INTEGER).
