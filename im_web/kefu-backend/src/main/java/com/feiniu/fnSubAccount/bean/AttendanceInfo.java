...
public class AttendanceInfo {
    ...
    private long sqlAttendanceLeaveNum;
    private long sqlAttendanceLeaveDuration;
    ...
    private String attendanceLeaveNum;
    private String attendanceLeaveDuration;


    public long getSqlAttendanceLeaveNum() {
        return sqlAttendanceLeaveNum;
    }

    public void setSqlAttendanceLeaveNum(long sqlAttendanceLeaveNum) {
        this.sqlAttendanceLeaveNum = sqlAttendanceLeaveNum;
    }

    public long getSqlAttendanceLeaveDuration() {
        return sqlAttendanceLeaveDuration;
    }

    public void setSqlAttendanceLeaveDuration(long sqlAttendanceLeaveDuration) {
        this.sqlAttendanceLeaveDuration = sqlAttendanceLeaveDuration;
    }

    public String getAttendanceLeaveNum() {
        return attendanceLeaveNum;
    }

    public void setAttendanceLeaveNum(String attendanceLeaveNum) {
        this.attendanceLeaveNum = attendanceLeaveNum;
    }

    public String getAttendanceLeaveDuration() {
        return attendanceLeaveDuration;
    }

    public void setAttendanceLeaveDuration(String attendanceLeaveDuration) {
        this.attendanceLeaveDuration = attendanceLeaveDuration;
    }
