...
import com.feiniu.fnSubAccount.bean.BaseWorkLoadInfo;
...
public class StatisticsUtil {
    ...
    public static void formateAttendanceInfoToShowData(AttendanceDetailInfo attendanceDetailInfoIndex){
        ...
        if (landingCount.intValue() != 0){
            ...
            BigDecimal leaveDuration = new BigDecimal(attendanceDetailInfoIndex.getSqlAttendanceLeaveDuration());
            ...
            leaveDuration = leaveDuration.divide(new BigDecimal(60), SystemConfig.DEFAULT_SCALE, BigDecimal.ROUND_HALF_EVEN);
            ...
            attendanceDetailInfoIndex.setLeaveNum(String.valueOf(attendanceDetailInfoIndex.getSqlAttendanceLeaveNum()));
            attendanceDetailInfoIndex.setLeaveDuration(leaveDuration.toString());
        }else {
            ...
            attendanceDetailInfoIndex.setLeaveNum("0.0");
            attendanceDetailInfoIndex.setLeaveDuration("0.0");
        }
    }
    ...
    public static void formateAttendanceInfoToShowData(AttendanceInfo attendanceInfoIndex){
        ...
        if (dayCount.intValue() != 0){
            ...
            BigDecimal leaveDuration = new BigDecimal(attendanceInfoIndex.getSqlAttendanceLeaveDuration());
            ...
            BigDecimal leaveDurationInHours= leaveDuration.divide(new BigDecimal(3600),
                    SystemConfig.DEFAULT_SCALE, BigDecimal.ROUND_HALF_EVEN);
            ...
            attendanceInfoIndex.setAttendanceLeaveNum(String.valueOf(attendanceInfoIndex.getSqlAttendanceLeaveNum()));
            attendanceInfoIndex.setAttendanceLeaveDuration(leaveDurationInHours.toString());
        }else {
            ...
            attendanceInfoIndex.setAttendanceLeaveNum("-");
            attendanceInfoIndex.setAttendanceLeaveDuration("-");
        }
        return;
    }
    //未响应量，需要过滤
    ...
    public static  AttendanceDetailInfo getEmptyAttendanceDetailInfo(long date){
        ...
        emptyInfo.setLeaveDuration("0.0");
        emptyInfo.setLeaveNum("0");
    ...
    public static  AttendanceInfo getEmptyAttendanceInfo(String name){
        ...
        emptyInfo.setAttendanceLeaveDuration("--");
        emptyInfo.setAttendanceLeaveNum("--");
        return emptyInfo;
    }
    //咨询量，接待量去重的函数
