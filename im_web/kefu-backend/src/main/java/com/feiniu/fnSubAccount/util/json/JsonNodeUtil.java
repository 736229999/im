package com.feiniu.fnSubAccount.util.json;
...
//String json = "{\"data\":[{\"id\":1,\"text\":\"椋炵墰\",\"state\":\"closed\",\"children\":[{\"id\":6,\"text\":\"椋炵墰鍟嗗煄鎷涘晢\",\"state\":\"closed\",\"children\":[{\"id\":7,\"text\":\"鍗庝腑鎷涘晢\",\"state\":\"open\"},{\"id\":10,\"text\":\"鍗庡寳鎷涘晢\",\"state\":\"open\"}]},{\"id\":8,\"text\":\"杩愯惀閮�\",\"state\":\"closed\",\"children\":[{\"id\":9,\"text\":\"涓荤\uE178瀹�\",\"state\":\"open\"},{\"id\":11,\"text\":\"鍏朵粬閮ㄩ棬\",\"state\":\"closed\",\"children\":[{\"id\":12,\"text\":\"鍏朵粬閮ㄩ棬1\",\"state\":\"closed\",\"children\":[{\"id\":13,\"text\":\"鍏朵粬閮ㄩ棬11\",\"state\":\"open\"}]}]}]}]}],\"code\":\"200\"}";
//
//CSOrganInfo organInfo = injectBean(json, CSOrganInfo.class, true);
//
//System.out.println(JsonUtil.toJsonString(organInfo));
//}
}
