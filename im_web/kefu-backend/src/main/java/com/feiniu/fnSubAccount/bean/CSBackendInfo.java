...
public class CSBackendInfo {
    ...
    public void setAgentoperatorid(int agentoperatorid) {
        this.agentoperatorid = agentoperatorid;
    }

    public String getCategorySeqs() {
        return categorySeqs;
    }

    public void setCategorySeqs(String categorySeqs) {
