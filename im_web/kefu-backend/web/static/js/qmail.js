...
(function (b) {
    var c = getTop(), a = {
        ...
        QMDialog: QMDialog,
        QMSelect: QMSelect,
        addPageMouseUpListener: function () {
...
(function (a, c) {
    ...
    b.prototype._initializeForIframe = function (h, f, g, e) {
        ...
        i._moEditorAreaObj.innerHTML = j._FRAME_BASE.replace({
            border: i._msStyle.indexOf(";border:none") != -1 ? "border:none;" : "",
            tabIdx: f,
            style: k
        });
        a.createBlankIframe(i._moEditorAreaWin, {
            obj: a.GelTags("textarea", i._moEditorAreaObj)[0].parentNode,
            where: "afterBegin",
            className: "qmEditorIfrmEditArea",
            scrolling: "auto",
            style: k,
            attrs: ["hideFocus", isNaN(f) ? "" : " tabIndex=" + f].join(""),
            header: j._FRAME_HEADER.replace({
                'base_href': 'href="' + i._moEditorAreaWin.location.protocol + '//' + i._moEditorAreaWin.location.host + '"',
                'base_target': ''
            }),
            body: j._FRAME_BODY.replace({
                editable: i._hasDesignMode(document) ? "" : "contentEditable=true",
    ...
    b.prototype._initializeForTxt = function (h, f, g, e) {
        var i = this, j = i._moTemplate, k = i._mnFixedHeight ? "height:" + i._mnFixedHeight : "";
        i._moEditorAreaObj.innerHTML = i._moTemplate._FRAME_BASE.replace({
            editcontainer: i._moTemplate._FRAME_TXT.replace({
                style: k,
                tabIdx: f
            }), border: i._msStyle.indexOf(";border:none") != -1 ? "border:none;" : "", style: k
        });
        i._msEditCore = "txt";
            ...
            a.E(h, function (k) {
                if (!k.funcObj) {
                    ...
                    if (b.FUNCLIB[m]) {
                        ...
                        k.funcObj = new b.FUNCLIB[m]({
                            oParamSet: f._moParamSet,
                            container: k.funcArea,
                            editor: f,
                            uiType: i
                        });
    ...
    b.prototype._setFocusEvent = function () {
        ...
        a.addEvents("txt" === f._msEditCore ? f._moEditBody : f._moEditWin, {
            focus: function (g) {
                if (!f._mbIsFocus) {
                    f._mbIsFocus = true;
                    if (a.gbIsFF) {
    ...
    b.CONST.FILES = {
        "$js_path$/com/kits/qmeditor/base/js/editor_toolbar24e6b9.js": "Separate Bold Italic Underline FontName FontName FontSize ForeColor BackColor AlignMode Serial Indent Quot CreateLink SourceEdit Preview SpellCheck UploadEml",
        "$js_path$/com/kits/qmeditor/base/js/editor_toolbar_plus24e6b9.js": "ClipImg Photo ScreenSnap Mo Music"
    };
    b.CONST.FUNCLIST = {};
    ...
    b.CONST.FUNCLIST.BIZMAIL_COMPOSE = {
        toolbar: "Bold Italic Underline | FontName FontSize ForeColor BackColor | AlignMode Serial Indent Quot | CreateLink SourceEdit Preview SpellCheck",
        tbExtern: "Photo ScreenSnap Mo"
    };
    b.CONST.FUNCLIST.QF_COMPOSE = {
    ...
    b.CONST._TEMPLATE = {
        _FRAME_BASE: a.T(['<table cellspacing=0 cellpadding=0 class="qmEditorBase" style="$border$" >', '<tr style="display:none;"><td height="10px" class="qmEditorToolBar" valign="top" unselectable="on">', '<div class="qmEditorToolBarDiv">', '<div></div><div style="display:none;"></div><div class="qmEditorBtnIcon" style="width:1px;" ></div>', '</div>', '</td></tr>', '<tr><td height="100%" valign="top" unselectable="on" class="qmEditorContent">', '$editcontainer$', '<textarea class="qmEditorText" tabindex="$tabIdx$" style="display:none;font-size:12px;$style$"></textarea>', '<textarea class="qmEditorText" tabindex="$tabIdx$" style="display:none;font-size:12px;$style$"></textarea>', '</td></tr>', '</table><div class="qmEditorBaseBd"></div>']),
        _FRAME_DIV: a.T(['<div class="qmEditorDivEditArea">$content$</div>']),
        _FRAME_TXT: a.T(['<textarea class="qmEditorText" tabindex="$tabIdx$" style="font-size:12px;$style$"></textarea>']),
        _FRAME_HEADER: a.T(['<script>', 'window.onerror = function() { return true; };', '</script>', '<style>', 'body {margin:0;overflow:auto;font:normal 14px Verdana;background:#fff;padding:2px 4px 0;cursor:text;}', 'body, p, font, div, li { line-height: 1.5;}', 'body, td, th {color:#000000;}', '.i {width:100%;*width:auto;table-layout:fixed;}', 'pre {white-space: pre-wrap;white-space: -moz-pre-wrap;white-space: -pre-wrap;white-space: -o-pre-wrap;word-wrap: break-word;}', 'a img {border:none;}', 'a { color: -moz-hyperlinktext !important;text-decoration: -moz-anchor-decoration;}', '</style>', '<base $base_href$ $base_target$ />']),
        _FRAME_BODY: a.T(['<body $editable$ $accesskey$>$content$</body>']),
        _TOOLBAR_ITEM: a.T(['<div class="qmEditorToolBarItem unselect" unselectable="on"></div>']),
        _TBEXTERN_ITEM: a.T(['<span class="editor_btn unselect"></span>']),
        BOTTON_ICON: a.T(['<div class="qmEditor$id$ qmEditorBtnIcon$id$ qmEditorBtnIcon unselect $ui.clsName$" unselectable="on" >', '<input type="button" class="qmEditorIcon" unselectable="on" onmousedown="return false;" />', '</div>']),
        BOTTON_TEXT: a.TE(['<a class="editor_btn_text qmEditor$id$ $ui.clsName$" $@$if($id$=="Music")$@$opt="music"$@$endif$@$>', '$ui.label$', '</a>', '$@$if($ui.moreBtn$)$@$', '<span class="ico_moreupload" opt="more"></span>', '$@$endif$@$']),
        BOTTON_BIG: a.T(['<a class="qmEditor$id$ qmEditorBtnText$id$ qmEditorBtnText unselect $ui.clsName$" unselectable="on">', '$ui.label$', '</a>']),
        _MENU_BORDER: a.T(['<div class="qmEditorMenuBorder" style="display:none;$style$" unselectable="on" onmousedown="return false;" >$innerHTML$</div>']),
        _MENU_ITEM: a.T(['<div class="qmEditorMenuItem" param="$param$" style="$style$;" unselectable="on" $event$ >', '$content$', '</div>']),
        _MENU_ITEM_EVENT: a.T(['onmouseover="', 'if ( this.className != \'QMEditorMenuItemDisabled\' && this.className != \'qmEditorMenuItemOver\' )', '{', 'this.className = \'qmEditorMenuItemOver\';', '}', '" onmouseout="', 'var _sClassName = this.getAttribute( \'curclass\' ) || \'qmEditorMenuItem\';', 'if ( this.className != _sClassName )', '{', 'this.className = _sClassName', '}', '" '])
    };
...
(function (a, b) {
    ...
    QMEditor.FUNCLIB.BASE.prototype._setup = function (c) {
        ...
        if (this._msType != "label") {
            if (typeof (this._mfOnClick) != "function") {
                var f = this, d = {
                    btn: f._doDefaultClick,
                    checkbox: f._doDefaultClick,
                    menu: f._doShowMenuClick
                }[f._msType];
    ...
    QMEditor.FUNCLIB.BASE.prototype._getUI = function () {
        var e = typeof (this._msUiType) != "string" ? (this._msUiType = "icon") : this._msUiType, d = this._moBindEditor._moTemplate[["BOTTON_", e.toUpperCase(), (this._msType == "custom" ? "_" + this._msId.toUpperCase() : "")].join("")] || "", c = {
            id: this._msId,
            ui: this._moUiConfig || {}
        };
        return d.replace(c);
    ...
    QMEditor.FUNCLIB.BASE.prototype._setEditorEvent = function (c) {
        var d = {
            "keydown": this._mfOnKeyDown,
            "keyup": this._mfOnKeyUp,
            "selectionchange": this._mfOnSelectionChange,
            "contextmenu": this._mfOnContextMenu,
            "paste": this._mfOnPaste
        }[c];
        var e = this;
    ...
    QMEditor.FUNCLIB.MENU.prototype.showMenu = function (c, d) {
        ...
        m._moMenuCfg = d;
        m._moMenu = new a.QMMenu({
            oEmbedWin: this._moBindEditor.getEditorAreaWin(),
            nWidth: i || "auto",
            nZIndex: 1121,
            sWidthDetect: "float",
            nItemHeight: (d && d.nItemHeight || this._moUiConfig.itemHeight) || b,
            nArrowPos: g ? g < 10 ? 10 : g : 0,
            nX: j + (g ? (m._msUiType == "text" ? 25 : 8) : 0),
            nY: l[2] + (g ? -4 : 5),
            oItems: k,
            bAutoClose: d.bAutoClose || k.length > 1,
            bProxyScroll: d.bAutoClose || k.length > 1,
            onload: function () {
                m._mnShowCount++;
                m.initMenu(this, d);
            },
...
(function (a, b) {
    ...
    QMEditor.EditMenu._TEMPLATE = {
        _EDIT_MENU_CONTAINER: '<div unselectable="on" id="QMEditorMenuBar" class="menubarbg editormenubar" style="display:none; z-index:120;"></div>',
        _IMG_MENU_CONTENT: a.TE(['<a func="zoom1_1" class="menubarbg imgzoomoriginal" title="\u539F\u59CB\u5927\u5C0F" unselectable="on"></a>', '<a func="zoomout" class="menubarbg imgzoomout" title="\u7F29\u5C0F" unselectable="on"></a>', '<span class="menubarbg imgzoombar" unselectable="on"><a id="zoomhandle" func="drag" class="menubarbg zoomhandle" title="$size$" unselectable="on" style="left:$pixels$"></a></span>', '<a func="zoomin" class="menubarbg imgzoomin" title="\u653E\u5927" unselectable="on"></a>', '<span class="menubarbg menubarspl" unselectable="on"></span>', '<a func="del" unselectable="on" class="menubarbg menubarremove" title="\u5220\u9664\u56FE\u7247" href="javascript:;"></a>']),
        _IMG_MENU_BAR_IMG: a.TE(['<span id="QMEditorIMGMenu">$imgcontent$</span>']),
        _IMG_MENU_BAR_LINK: a.TE(['<span class="menubarbg menubariconlink" unselectable="on"></span>', '<span id="QMEditMenuCommon" class="linkcommon" unselectable="on">', '<span style="max-width:184px; overflow:hidden; height:23px;float:left;"><a class="menubarlink" id="QMEditMenuLink" href="$@$eval (getTop().htmlEncode($link$))$@$" unselectable="on" target="_blank" style="white-space:nowrap;">$@$eval (getTop().htmlEncode($link$))$@$</a></span>', '<span class="menubarbg menubarspl" unselectable="on"></span>', '<a href="javascript:;" func="modify" class="menubarbg linkmodify" title="\u4FEE\u6539\u94FE\u63A5" unselectable="on"></a>', '<span class="menubarbg menubarspl" unselectable="on"></span>', '<a func="unlink" unselectable="on" class="menubarbg menubarremove" title="\u6E05\u9664\u94FE\u63A5" unselectable="on"></a>', '</span>', '<span id="QMEditMenuModify" class="linkedit" style="display:none;" unselectable="on">', '<input type="text" id="QMEditMenuInput" class="menubarinput"/>', '<span class="menubarbg menubarspl" unselectable="on"></span>', '<a func="save" class="menubarbg menubarfinish" title="\u786E\u5B9A" unselectable="on"></a>', '</span>']),
        _IMG_MENU_BAR_IMG_MAP: a.TE(['<span id="QMEditorIMGMenu">', '<a href="javascript:;" func="editmap" class="menubarbg linkmodify" title="\u7F16\u8F91" unselectable="on" src="$img_map$"></a>', '<span class="menubarbg menubarspl" unselectable="on"></span>', '<a href="javascript:;" func="jumptomap" class="menubarbg menubarpreview" title="\u9884\u89C8" unselectable="on" src="$img_map$"></a>', '<span class="menubarbg menubarspl" unselectable="on"></span>', '<a href="javascript:;" func="del" class="menubarbg menubarremove" title="\u5220\u9664\u56FE\u7247" unselectable="on"></a>', '</span>']),
        _IMG_MENU_BAR: a.TE(['<a func="showimg" class="menubarbg menubariconimg" title="\u7F16\u8F91\u56FE\u7247"></a>', '<span class="menubarbg menubarspl"></span>', '<a func="showlink" class="menubarbg menubariconlink2" title="\u7F16\u8F91\u94FE\u63A5"></a>'])
    };
                ...
                switch (B) {
                    ...
                    case "editmap":
                    {
                        ...
                        if (z && a.attr(z, "ui-type") == "share_map") {
                            var s = f.getMapFunc();
                            s._doDefaultClick.call(s, {
                                searchKeyword: a.attr(z, "skwd") || "",
                                title: a.attr(z, "stitle") || "",
                                center: a.attr(z, "center") || "",
                                pos: a.attr(z, "pos") || "",
                                zoom: parseInt(a.attr(z, "zoom") || 15),
                                posDesc: a.attr(z, "desc") || ""
                            });
                        }
                        break;
                    }
    ...
    QMEditor.EditMenu.prototype._checkEditMenuType = function (f, e) {
        var m = this, k = m._moBindEditor, i = null, j = null, g = true, h = 0, p = "", q = "", r = "", n = QMEditor.EditMenu._TEMPLATE, o = {
            "1": n._IMG_MENU_BAR_LINK,
            "2": n._IMG_MENU_BAR_IMG,
            "3": n._IMG_MENU_BAR,
            "4": n._IMG_MENU_BAR_IMG_MAP
        };
        if (!f) {
        ...
        p = o[h] ? o[h].replace({
            "link": ((i && i.href) || ""),
            "images_path": k._msResPath,
            "imgcontent": q,
            "img_map": getTop().attr(j, "jump")
        }) : "";
        return {"sHtml": p, "oEditObj": j};
    };
    QMEditor.EditMenu.prototype._getImgMenuContent = function (e, f) {
        return (f._IMG_MENU_CONTENT.replace({
            "size": e.getAttribute("modifysize") || "100%",
            "pixels": e.getAttribute("diffpixels") || "25px"
        }));
    };
    ...
    QMEditor.EditMenu.prototype._fView = function (f, e, g, h) {
        ...
        var p = m.getAttribute("scalingmode") || "zoom", r = {
            "zoom": {
                "25": "-1px",
                "50": "8px",
                "75": "16px",
        ...
        }[p], j = {"zoom": 200, "normal": 100}[p], k = {"zoom": 25, "normal": 1}[p], i = {
            "zoom": 25,
            "normal": 10
        }[p], l = {"zoom": 175, "normal": 100}[p], q = "";
...
(function (a, c) {
    ...
    QMEditor.CONST.FILES = {
        "$js_path$/com/kits/qmeditor/qqmail/release/editor_toolbar270dbd.js": "Separate Bold Italic Underline FontName FontName FontSize ForeColor BackColor AlignMode Serial Indent Quot CreateLink SourceEdit Preview SpellCheck UploadEml FullScreen FormatMatch",
        "$js_path$/com/kits/qmeditor/qqmail/release/editor_toolbar_plus28f6b6.js": "ClipImg Photo ScreenSnap NetDisk Mo Word More Map"
    };
    QMEditor.CONST.FUNCLIST.COMPOSE = {
        toolbar: "Bold Italic Underline FontName FontSize ForeColor BackColor AlignMode Serial Indent Quot CreateLink FormatMatch SpellCheck SourceEdit FullScreen",
        tbExtern: "Photo Word ScreenSnap NetDisk Mo More Map"
    };
    QMEditor.CONST.FUNCLIST.GROUP = {
        toolbar: "Bold Italic Underline FontName FontSize ForeColor BackColor AlignMode Serial Indent Quot CreateLink FormatMatch SourceEdit FullScreen",
        tbExtern: "Photo Word ScreenSnap NetDisk Mo More Map"
    };
    QMEditor.CONST.FUNCLIST.BIZMAIL_COMPOSE = {
        toolbar: "Bold Italic Underline | FontName FontSize ForeColor BackColor | AlignMode Serial Indent Quot | CreateLink SourceEdit Preview SpellCheck",
        tbExtern: "Photo ScreenSnap NetDisk Mo"
    };
...
(function (a, b) {
    ...
    QMEditor.EditMenu.prototype.rotateImg = function () {
        ...
        var g = a.getSid(), i = QMEditor.EditMenu._TEMPLATE._IMG_ROTATE_URL.replace({
            rotatekey: f.replace("f=", "fkey="),
            degree: e,
            sid: g
        });
        a.QMAjax.send(i, {
            method: "GET", onload: function (j, k) {
                if (j) {
                    var l = evalValue(k);
