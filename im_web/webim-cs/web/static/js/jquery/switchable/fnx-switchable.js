/*!
 * FNX-UI v1.1.0 ()
 * Copyright 2014-2015 by FNX-UI Team
...
;(function (window) {
  ...
  __namespace__('$',function(__using__,exports,module){
      ...
      root.find('[data-widget]').each(function(i, element) {
        if (!exports.isDataApiOff(element)) {
          ...
          if (id.indexOf(DATA_WIDGET_CLZ_PREFIX) === 0) {
            id = id.substring(DATA_WIDGET_CLZ_PREFIX.length);
          }
...
// 对于 attrs 的 value 来说，以下值都认为是空值： null, undefined
  ...
  __include__['$'] = FNX.__clz__['fnx/cmp/$'];
  ...
  __namespace__('switchable/basic/switchable-basic',function(__using__,exports,module){
    ...
    var SwitchableBasic = Widget.extend({
      ...
      _initTriggers: function (role) {
        ...
        if (length <= 1 && this.get('autoHideTrigger')) {
          triggers.hide();
        }
      },
