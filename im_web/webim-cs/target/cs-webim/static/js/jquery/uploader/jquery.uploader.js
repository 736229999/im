    ...
    (function (window, $, undefined) {
        ...
        Uploader.flash = Uploader.extend(function () {
            ...
            return {
                ...
                create: function (style) {
                    ...
                    if (opt.preview) {
                        /**
                         * modified by morningking @ 2015/07/28
                         */
                        //params.preview = 1;
                        if (isOriginalIE8) {
        ...
        $.fn.uploader = function (options) {
            ...
            if (typeof options === 'string' && options.substr(0, 2) !== 'on') {
                ...
                //hacked by morningking @ 2015/08/04 ie10上传问题
                var isIe = !!window.ActiveXObject || "ActiveXObject" in window;

                if (!Uploader[options.mode] || isIe) options.mode = 'flash';
                this.each(function () {
