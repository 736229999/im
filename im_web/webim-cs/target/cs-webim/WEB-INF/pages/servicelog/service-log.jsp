...
<div id="D_right_ifm">
    ...
    <div id="J_store_info" class="with">
        ...
        <ul class="ui-info-list ui-line">
            ...
            <li>昵称：<span id="customerNickName">lishanshan</span>
                <span class="fr">会员等级：<span id="customerLevel">普通会员</span></span>
            </li>
        </ul>
        ...
        <ul class="ui-info-list ui-line">
            <li>最近交易：<span  id="lastOrderTime">2015-07-10 19:20:33</span> <span class="fr" id= "lastOrderStatus">交易完成</span></li>
            <li>订单编号：<span  id="lastOrderId">20150802918pc121290</span><span class="fr" id= "lastTotalCost">合计：<em>￥123.00</em></span> </li>

        </ul>
        <ul class="ui-info-list">
            <li>累计成交:<span  id= "allDealCount">25笔</span>,<span  id= "totalGoodsNum">1000</span>件宝贝</li>
