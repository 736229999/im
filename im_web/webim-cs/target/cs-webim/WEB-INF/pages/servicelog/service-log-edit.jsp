...
<div id="D_right_ifm">
    ...
    <div id="J_store_info" class="with">
        ...
        <ul class="ui-info-list ui-line">
            ...
            <li>昵称：<span class="fr" id="nickName">lishanshan</span><span class="fr" id= "level">会员等级：普通会员</span> </li>

        </ul>
        <div id="consultative-prd" class="ui-line">
            <ul class="ui-info-list">
                <li>订单编号：<span class="fr" id= "orderID">20150802918pc121290</span><span class="fr" id= "result">交易完成</span></li>
            </ul>
        ...
        <ul class="ui-info-list ui-line">
            <li>最近交易：<span class="fr" id="dealTime">2015-07-10 19:20:33</span> <span class="fr" id= "dealResult">交易完成</span></li>
            <li>订单编号：<span class="fr" id="dealOrder">20150802918pc121290</span><span class="fr" id= "totalCost">合计：<em>￥123.00</em></span> </li>
    ...
    <div id="J_product_info" style="display:none;">
        <div class="fill">
            <div class="f_content">
                ...
                <div class="handle">
                    <ul>
                        <li><span><b class="red">＊</b>服务类型：</span><p>客诉</p></li>
                        <li><span><b class="red">＊</b>优先级：</span><p>急件</p></li>
                ...
                <div class="Commodity">
                    ...
                    <ul>
                        <li><i></i><span>植物意思清华大学是什么会是呢？没有搞明白。</span><div class="info" style="display:none; margin-left:13px;"><span>植物意思清华大学是什么会是呢？没有搞明白。</span><span>植物意思清华大学是什么会是呢？没有搞明白。</span><span>植物意思清华大学是什么会是呢？没有搞明白。</span></div></li>
                        <li><i></i><span>植物意思清华大学是什么会是呢？没有搞明白。</span><div class="info" style="display:none; margin-left:13px;"><span>植物意思清华大学是什么会是呢？没有搞明白。</span><span>植物意思清华大学是什么会是呢？没有搞明白。</span><span>植物意思清华大学是什么会是呢？没有搞明白。</span></div></li>
                    </ul>
                </div>
                <div class="Contact">
                ...
                <div class="History">
                    <h2>历史小记：</h2>
                    <ul>
                        <li><p><em></em>2015-08-03 22:12:23    客服001</p><p class="on">买家咨询订单201507CP100135物流情况。</p></li>
                        <li><p><em></em>2015-08-03 22:12:23    客服001</p><p class="on">买家咨询订单201507CP100135物流情况。</p></li>
                        <li><p><em></em>2015-08-03 22:12:23    客服001</p><p class="on">买家咨询订单201507CP100135物流情况。</p></li>
                        <li><p><em></em>2015-08-03 22:12:23    客服001</p><p class="on">买家咨询订单201507CP100135物流情况。</p></li>
                    </ul>
