...
import com.feiniu.csWebIm.bean.domain.FaqBrowseInfo;
import com.feiniu.csWebIm.bean.request.FAQRequest;
import com.feiniu.csWebIm.bean.vo.FAQViewDetail;
import com.feiniu.csWebIm.repository.FAQDao;
import com.feiniu.csWebIm.utils.TransformService;
...
public class FAQDaoImpl implements FAQDao {
    ...
    public void addFAQ(FAQ faq) {
        ...
        FaqBrowseInfo faqBrowseInfo = new FaqBrowseInfo();
        faqBrowseInfo.setFaqID(faq.getFaqID());
        faqBrowseInfo.setViewCount(0);
        faqBrowseInfo.setViewDate(System.currentTimeMillis());
        faqBrowseInfo.setUpdateTime(new Timestamp(System.currentTimeMillis()));

        session.save(faqBrowseInfo);
    }
    ...
    public void updateBrowseInfo(int faqID) {
        sessionFactory.getCurrentSession().createQuery("update FaqBrowseInfo set viewCount = viewCount + 1, updateTime = systimestamp" +
                " where faqID = :faqID")
