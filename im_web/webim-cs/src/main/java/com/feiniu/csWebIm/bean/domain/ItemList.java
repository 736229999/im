...
public class ItemList {
    ...
    private Integer shoppingCash;
    private Integer shoppingCard;
    ...
    public Integer getShoppingCash() {
        return shoppingCash;
    }

    public void setShoppingCash(Integer shoppingCash) {
    ...
    public void setShoppingCard(Integer shoppingCard) {
