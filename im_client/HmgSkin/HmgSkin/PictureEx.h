...
class AFX_EXT_CLASS CPictureEx : public CStatic
{
public:
...
//	BOOL SetPaintRect(const RECT *lpRect);
	...
	BOOL Load(HINSTANCE hResourceInstance,LPCTSTR szResourceName,LPCTSTR szResourceType);
