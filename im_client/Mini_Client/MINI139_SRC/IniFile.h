...
public:
	...
	int setStringValue(const string &section, const string &key, const char *value, const string &comment = "");
	int setIntValue(const string &section, const string &key, int value, const string &comment = "");
	int setDoubleValue(const string &section, const string &key, double value, const string &comment = "");
