...
void IniFile::trim(string &str)
{
    ...
    while (str[i] == ' '/*isspace(str[i])*/ && str[i] != '\0') {
        i++;
    }
...
int IniFile::setStringValue(const string &section, const string &key, const char *value, const string &comment /*= ""*/)
{
	string strValue(value);	
	return setValue(section, key, strValue, comment);
}

int IniFile::setIntValue(const string &section, const string &key, int value, const string &comment /*= ""*/)
{
	char szValue[1024] = {0};
...
int IniFile::setDoubleValue(const string &section, const string &key, double value, const string &comment /*= ""*/)
{
	char szValue[1024] = {0};
