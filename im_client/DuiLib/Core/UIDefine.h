...
#define DUI_MSTTYPE_MOUSEHOVER			   (_T("mousehover"))	
...
#define  DUI_CTR_PWD							 (_T("Password"))	

#define  DUI_CTR_SLIDER_TABLAYOUT				 (_T("SliderTabLayout")) 	

#define  DUI_CTR_BUTTON_GIF                      (_T("ButtonGif"))
///
//////////////END控件名称宏定义//////////////////////////////////////////////////
