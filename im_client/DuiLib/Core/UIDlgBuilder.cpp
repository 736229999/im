    ...
    for( CMarkupNode node = pRoot->GetChild() ; node.IsValid(); node = node.GetSibling() ) {
		...
		//树控件XML解析
            ...
            case 8:
				...
				else if( _tcscmp(pstrClass, DUI_CTR_PWD) == 0 )				  pControl = new CPasswordUI;
                break;
            case 9:
				...
				else if( _tcscmp(pstrClass, DUI_CTR_BUTTON_GIF) == 0 )        pControl = new CButtonGifUI; 
                break;
            case 10:
            ...
            case 15:
				...
				else if( _tcscmp(pstrClass, DUI_CTR_SLIDER_TABLAYOUT) == 0 )  pControl = new CSliderTabLayoutUI;
                break;
            case 16:
