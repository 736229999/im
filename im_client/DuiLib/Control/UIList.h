...
public:
	...
	void SetItemIsDrawHotBkColor(bool bDraw);
protected:
...
public:
	...
	void SetDrawBkColor(DWORD dwBackColor);
	bool IsItemHot();
    virtual void DrawItemBk(HDC hDC, const RECT& rcItem);

	void SetPos(RECT rc);

	void SetMousemoveBtnVisible(std::vector<CButtonUI*>& vecBtnUI);
protected:
    int m_iIndex;
    bool m_bSelected;
    UINT m_uButtonState;
    IListOwnerUI* m_pOwner;
	std::vector<CButtonUI*> m_vecBtnUI;
	DWORD m_dwDrawBackColor;
};
