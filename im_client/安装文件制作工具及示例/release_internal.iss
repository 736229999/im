...
AppVersion=1.0.1.2
AppPublisher=飞牛网
DefaultDirName={pf}\MouMou_Internal
DefaultGroupName=MouMou_Internal
UninstallDisplayName= 哞哞内部版 1.4.0.0
UninstallDisplayIcon={app}\MouMou.exe
Compression=lzma2
SolidCompression=yes
SetupIconFile="ReleaseVersionBuyer\MouMou.ico"
OutputDir="Release"
OutputBaseFilename=MouMou_Internal_1.4.0.0
...
Source: "ReleaseVersionBuyer\serverlist.config"; DestDir: "{app}" 
...
[Icons]
Name: "{group}\MouMou内部版"; Filename: "{app}\MouMou.exe";WorkingDir: "{app}"
Name: "{group}\{cm:UninstallProgram,MouMou内部版}"; Filename: "{uninstallexe}"
Name: "{userdesktop}\MouMou内部版"; Filename: "{app}\MouMou.exe"
...
var
  ...
  ResultCode: Integer;
begin
    HasRun := FindWindowByWindowName('哞哞内部版2015');
    while HasRun<>0 do
    begin
...
function  InitializeSetup():boolean;
  ...
  begin
    ...
    If RegQueryStringValue(HKEY_LOCAL_MACHINE, 'SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\哞哞内部版_is1', 'UninstallString', uicmd) then
    begin
