...
COLORREF CStaticLink::g_colorUnvisited = RGB(255,0,0);		 // blue
COLORREF CStaticLink::g_colorVisited   = RGB(0,0,255);		 // purple
...
//		hbr = HBRUSH(CBrush(RGB(255, 255, 255)));
	}
...
//	HINSTANCE h = m_link.Navigate();
	HINSTANCE h = ShellExecute(0, _T("open"), m_strHyperLink, 0, 0, SW_SHOWNORMAL);
	if ((UINT)h > 32)
	{						 // success!
